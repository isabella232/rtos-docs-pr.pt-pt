...
ms.locfileid: "116801853"
---
# <a name="appendix-b---azure-rtos-threadx-constants"></a>Apêndice B - Azure RTOS ThreadX Constants

- [**Listagens alfabéticas**](#alphabetic-listings) 
- [**Listagem por Valor**](#listing-by-value)

## <a name="alphabetic-listings"></a>Listagens alfabéticas

| Constante (por alfabético) | Valor |
| --------- | - |
| TX_1_ULONG | 1 |
| TX_2_ULONG | 2 |
| TX_4_ULONG | 4 |
...
| TX_WAIT_ERROR | 0x04 |
| TX_WAIT_FOREVER | 0xFFFFFFFFFFUL |
|  |  |

## <a name="listing-by-value"></a>Listagem por Valor

| Constante (por valor) | Valor  |
| ------------- | - |
| TX_DONT_START | 0 |
| TX_FALSE | 0 |
| TX_NO_ACTIVATE | 0 |
