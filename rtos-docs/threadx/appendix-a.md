---
title: Apêndice A - Azure RTOS ThreadX API Services
description: Explore os Serviços AZURE RTOS ThreadX API.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104825472"
---
# <a name="appendix-a---azure-rtos-threadx-api-services"></a><span data-ttu-id="b6c90-103">Apêndice A - Azure RTOS ThreadX API Services</span><span class="sxs-lookup"><span data-stu-id="b6c90-103">Appendix A - Azure RTOS ThreadX API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="b6c90-104">Função de entrada</span><span class="sxs-lookup"><span data-stu-id="b6c90-104">Entry Function</span></span>

```c
VOID      tx_kernel_enter(VOID);
```

## <a name="block-memory-services"></a><span data-ttu-id="b6c90-105">Bloquear serviços de memória</span><span class="sxs-lookup"><span data-stu-id="b6c90-105">Block Memory Services</span></span>
...
## <a name="byte-memory-services"></a><span data-ttu-id="b6c90-106">Serviços de Memória Byte</span><span class="sxs-lookup"><span data-stu-id="b6c90-106">Byte Memory Services</span></span>
...
## <a name="event-flags-services"></a><span data-ttu-id="b6c90-107">Serviços de Bandeiras de Eventos</span><span class="sxs-lookup"><span data-stu-id="b6c90-107">Event Flags Services</span></span>
...
## <a name="interrupt-control"></a><span data-ttu-id="b6c90-108">Controlo de Interrupção</span><span class="sxs-lookup"><span data-stu-id="b6c90-108">Interrupt Control</span></span>

```c
UINT      tx_interrupt_control(UINT new_posture);
```

## <a name="mutex-services"></a><span data-ttu-id="b6c90-109">Serviços Mutex</span><span class="sxs-lookup"><span data-stu-id="b6c90-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="b6c90-110">Serviços de fila</span><span class="sxs-lookup"><span data-stu-id="b6c90-110">Queue Services</span></span>
...
## <a name="semaphore-services"></a><span data-ttu-id="b6c90-111">Serviços Semáforos</span><span class="sxs-lookup"><span data-stu-id="b6c90-111">Semaphore Services</span></span>
...
## <a name="thread-control-services"></a><span data-ttu-id="b6c90-112">Serviços de Controlo de Fios</span><span class="sxs-lookup"><span data-stu-id="b6c90-112">Thread Control Services</span></span>
...
## <a name="time-services"></a><span data-ttu-id="b6c90-113">Serviços de Tempo</span><span class="sxs-lookup"><span data-stu-id="b6c90-113">Time Services</span></span>
...
## <a name="timer-services"></a><span data-ttu-id="b6c90-114">Serviços de temporizador</span><span class="sxs-lookup"><span data-stu-id="b6c90-114">Timer Services</span></span>
