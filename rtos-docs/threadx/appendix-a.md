...
---
# <a name="appendix-a---azure-rtos-threadx-api-services"></a>Apêndice A - Azure RTOS ThreadX API Services

## <a name="entry-function"></a>Função de entrada

```c
VOID      tx_kernel_enter(VOID);
```

## <a name="block-memory-services"></a>Bloquear serviços de memória
...
## <a name="byte-memory-services"></a>Serviços de Memória Byte
...
## <a name="event-flags-services"></a>Serviços de Bandeiras de Eventos
...
## <a name="mutex-services"></a>Serviços Mutex
...
```
## <a name="queue-services"></a>Serviços de fila
...
## <a name="semaphore-services"></a>Serviços Semáforos
...
## <a name="thread-control-services"></a>Serviços de Controlo de Fios
...
## <a name="time-services"></a>Serviços de Tempo
...
## <a name="timer-services"></a>Serviços de temporizador
