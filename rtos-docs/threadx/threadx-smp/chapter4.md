...
Este capítulo contém uma descrição de todos os serviços Azure RTOS ThreadX SMP por ordem alfabética. Os seus nomes são concebidos para que todos os serviços semelhantes sejam agrupados. Na secção "Valores de Retorno" nas seguintes descrições, os valores em **BOLD** não são afetados pela **TX_DISABLE_ERROR_CHECKING** definem utilizados para desativar a verificação de erros da API; enquanto os valores mostrados em nãobold são completamente desativados. Além disso, um "**Sim**" listado sob a rubrica "**Preemption Possible**" indica que ligar para o serviço pode retomar um fio de maior prioridade, antecipando assim o fio de chamada.

- **tx_block_allocate**: *Atribuir bloco de memória de tamanho fixo* 
- **tx_block_pool_create**: *Criar um conjunto de blocos de memória de tamanho fixo* 
- **tx_block_pool_delete**: *Eliminar o conjunto de blocos de memória* 
- **tx_block_pool_info_get**: *Recuperar informações sobre a piscina de blocos* 
- **tx_block_pool_performance_info_get**: *Obtenha informações sobre desempenho do bloco de piscina* 
- **tx_block_pool_performance_system_info_get**: *Obtenha informações sobre o desempenho do sistema de piscinas de blocos* 
- **tx_block_pool_prioritize**: *Priorize lista de suspensão de piscina de bloco* 
- **tx_block_release**: *Liberte o bloco de memória de tamanho fixo*
- **tx_byte_allocate**: *Aloque bytes de memória* 
- **tx_byte_pool_create**: *Criar piscina de memória de bytes* 
- **tx_byte_pool_delete**: *Apagar a piscina byte de memória* 
- **tx_byte_pool_info_get**: *Recuperar informações sobre a piscina byte* 
- **tx_byte_pool_performance_info_get**: *Obter informações sobre o desempenho da piscina byte* 
- **tx_byte_pool_performance_system_info_get**: *Obter informações sobre o desempenho do sistema de piscina byte* 
- **tx_byte_pool_prioritize**: *Prioritize byte pool suspension list* 
- **tx_byte_release**: *Liberte bytes de volta à piscina da memória* 
- **tx_event_flags_create**: *Criar grupo de bandeiras de eventos* 
- **tx_event_flags_delete**: *Eliminar grupo de bandeiras de eventos* 
- **tx_event_flags_get**: *Obtenha bandeiras de eventos do grupo de bandeiras de eventos* 
- **tx_event_flags_info_get**: *Recuperar informações sobre o grupo de bandeiras de eventos* 
- **tx_event_flags_performance_info_get**: *Obtenha informações de desempenho do grupo de bandeiras de eventos* 
- **tx_event_flags_performance_system_info_get**: *Recuperar informações do sistema de desempenho* 
- **tx_event_flags_set**: *Coloque bandeiras de evento em um grupo de bandeiras de evento* 
- **tx_event_flags_set_notify**: *Notifique a aplicação quando as bandeiras do evento forem definidas*
- **tx_interrupt_control**: *Ativar e desativar interrupções* 
- **tx_mutex_create**: *Criar mutex de exclusão mútua* 
- **tx_mutex_delete**: *Eliminar o mutex de exclusão mútua* 
- **tx_mutex_get**: *Obter a propriedade do mutex* 
- **tx_mutex_info_get**: *Recuperar informações sobre o mutex* 
- **tx_mutex_performance_info_get**: *Obtenha informações sobre desempenho de mutex* 
- **tx_mutex_performance_system_info_get**: *Obtenha informações sobre desempenho do sistema mutex* 
- **tx_mutex_prioritize**: *Prioritize lista de suspensão de mutantes* 
- **tx_mutex_put**: *Libertar a propriedade do mutex* 
- **tx_queue_create**: *Criar fila de mensagens* 
- **tx_queue_delete**: *Apagar fila de mensagens* 
- **tx_queue_flush**: *Mensagens vazias na fila da mensagem* 
- **tx_queue_front_send**: *Enviar mensagem para a frente da fila* 
- **tx_queue_info_get**: *Recuperar informações sobre a fila* 
- **tx_queue_performance_info_get**: *Obtenha informações sobre desempenho da fila* 
- **tx_queue_performance_system_info_get**: *Obtenha informações sobre o desempenho do sistema de fila*
- **tx_queue_prioritize**: *Priorize a lista de suspensão da fila* 
- **tx_queue_receive**: *Receba mensagem da fila da mensagem* 
- **tx_queue_send**: *Enviar mensagem para a fila da mensagem* 
- **tx_queue_send_notify**: *Notifique o pedido quando a mensagem é enviada para a fila* 
- **tx_semaphore_ceiling_put**: *Coloque um caso na contagem de semáforos com teto* 
- **tx_semaphore_create**: *Criar semáforo de contagem* 
- **tx_semaphore_delete**: *Eliminar o semáforo de contagem* 
- **tx_semaphore_get**: *Obtenha a ocorrência da contagem do semáforo* 
- **tx_semaphore_info_get**: *Recuperar informações sobre semáforos* 
- **tx_semaphore_performance_info_get**: *Obtenha informações sobre desempenho de semáforos* 
- **tx_semaphore_performance_system_info_get**: *Obtenha informações sobre o desempenho do sistema de semáforos* 
- **tx_semaphore_prioritize**: *Priorizar lista de suspensão de semáforos* 
- **tx_semaphore_put**: *Coloque um caso na contagem de semáforos* 
- **tx_semaphore_put_notify**: *Notifique o pedido quando o semáforo for colocado* 
- **tx_thread_create**: *Criar fio de aplicação* 
- **tx_thread_delete**: *Eliminar o fio da aplicação*
- **tx_thread_entry_exit_notify**: *Notifique o pedido após a entrada e saída do fio* 
- **tx_thread_identify**: *Recupera o ponteiro para a execução do fio* 
- **tx_thread_info_get**: *Recuperar informações sobre o fio* 
- **tx_thread_performance_info_get**: *Obtenha informações sobre desempenho de thread* 
- **tx_thread_performance_system_info_get**: *Obtenha informações sobre desempenho do sistema de fios* 
- **tx_thread_preemption_change**: *Alterar limiar de preempção do fio de aplicação* 
- **tx_thread_priority_change**: *Alterar prioridade do fio de aplicação* 
- **tx_thread_relinquish**: *Renunciar ao controlo a outros fios de aplicação* 
- **tx_thread_reset**: *Linha de reset* 
- **tx_thread_resume**: *Retomar o fio de aplicação suspenso* 
- **tx_thread_sleep**: *Suspender o fio de corrente por tempo especificado* 
- **tx_thread_smp_core_exclude**: *Exclua a execução de fios num conjunto de núcleos* 
- **tx_thread_smp_core_exclude_get**: *Obtém a exclusão atual do núcleo do fio* 
- **tx_thread_smp_core_get**: *Recupere atualmente o núcleo de execução do chamador* 
- **tx_thread_stack_error_notify**: *Registar chamada de notificação de erro de pilha de fio* 
- **tx_thread_suspend**: *Suspender o fio da aplicação*
- **tx_thread_terminate**: *Termina o fio da aplicação* 
- **tx_thread_time_slice_change**: *Altera a fatia de tempo do fio de aplicação* 
- **tx_thread_wait_abort**: *Abortar suspensão de fio especificado* 
- **tx_time_get**: *Recupera a hora atual* 
- **tx_time_set**: *Define a hora atual* 
- **tx_timer_activate**: *Ativar o temporizador de aplicações* 
- **tx_timer_change**: *Alterar o temporizador de aplicações* 
- **tx_timer_create**: *Criar temporizador de aplicações* 
- **tx_timer_deactivate**: *Temporizador de aplicação desativado* 
- **tx_timer_delete**: *Eliminar o temporizador de aplicações* 
- **tx_timer_info_get**: *Recuperar informações sobre um temporizador de aplicações* 
- **tx_timer_performance_info_get**: *Obtenha informações sobre desempenho do temporizador* 
- **tx_timer_performance_system_info_get**: *Obtenha informações sobre o desempenho do sistema do sistema temporizador* 
- **tx_timer_smp_core_exclude**: *Excluir a execução do temporizador num conjunto de núcleos* 
- **tx_timer_smp_core_exclude_get**: *Obtém a exclusão atual do núcleo do temporizador*
...
- **block_ptr**: Ponter para um ponteiro de bloco de destino. Na atribuição bem sucedida, o endereço do bloco de memória atribuído é colocado onde este parâmetro aponta.
- **wait_option**: Define como o serviço se comporta se não houver blocos de memória disponíveis. As opções de espera são definidas da seguinte forma:
    - **TX_NO_WAIT:**(0x00000000)
    - **TX_WAIT_FOREVER:**(0xFFFFFFFF)
    - valor de tempo limite: (0x00000001 através de 0xFFFFFFFE)  
    
    A seleção TX_NO_WAIT resulta numa devolução imediata deste serviço, independentemente de ter sido bem sucedida ou não. Esta é a única opção válida se o serviço for chamado de uma não linha; por exemplo, Inicialização, temporizador ou ISR.

    A seleção TX_WAIT_FOREVER faz com que o fio de chamada suspenda indefinidamente até que um bloco de memória esteja disponível.

    Selecionar um valor numérico (1-0xFFFFFFFE) especifica o número máximo de temporizadores para permanecer suspenso enquanto se espera por um bloco de memória.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Atribuição bem sucedida do bloco de memória.
- **TX_DELETED**: (0x01) A piscina do bloco de memória foi eliminada enquanto o fio foi suspenso.
- **TX_NO_MEMORY**: (0x10) O serviço não pôde atribuir um bloco de memória dentro do tempo especificado para esperar.
...
- **pool_ptr**: Pontear para um bloco de controlo de piscina de bloco de memória.
- **name_ptr**: Pontear o nome do bloco de memória.
- **block_size**: Número de bytes em cada bloco de memória.
- **pool_start**: Endereço inicial do conjunto do bloco de memória. O endereço inicial deve ser alinhado com o tamanho do tipo de dados ULONG..
- **pool_size**: Número total de bytes disponíveis para o conjunto do bloco de memória.
...
- **pool_ptr**: Ponteiro para o conjunto de blocos de memória previamente criado.
- **nome**: Ponteiro para destino para o ponteiro para o nome do pool do bloco.
- **disponível**: Ponteiro para o destino para o número de blocos disponíveis na piscina de blocos.
- **total_blocks**: Ponte para o destino para o número total de blocos na piscina de blocos.
- **first_suspended**: Ponter para o destino para o ponteiro para o fio que é o primeiro na lista de suspensão deste bloco pool.
- **suspended_count**: Ponter para o destino para o número de fios atualmente suspensos neste bloco.
- **next_pool**: Ponter para o destino para o ponteiro do próximo conjunto de blocos criado.
...
> [!IMPORTANT]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_BLOCK_POOL_ENABLE_PERFORMANCE_INFO** definidas para este serviço devolver informações de desempenho.

### <a name="parameters"></a>Parâmetros

- **pool_ptr**: Ponteiro para o conjunto de blocos de memória previamente criado.
- **atribuições**: Ponteiro para destino para o número de pedidos de atribuição realizados nesta piscina.
- **lançamentos**: Ponteiro para o destino para o número de pedidos de libertação realizados nesta piscina.
...
- **TX_SUCCESS**: (0x00) Desempenho bem sucedido da piscina do bloco obtém.
...
- **atribuições**: Ponteiro para destino para o número total de pedidos de atribuição realizados em todas as piscinas de blocos.
...
- **intervalos :** Ponte para o destino para o número total de intervalos de suspensão atribuídos em todas as piscinas de blocos.
...
- **TX_SUCCESS**: (0x00) O desempenho do sistema de piscina de blocos bem sucedido.
- **TX_FEATURE_NOT_ENABLED**: (0xFF) O sistema não foi compilado com informações de desempenho ativadas.
...
- **block_ptr**: Ponter para o bloco de memória previamente atribuído.
...
- **pool_ptr**: Ponteiro para um conjunto de memórias previamente criado.
- **memory_ptr**: Ponteiro para um ponteiro de memória de destino. Na atribuição bem sucedida, o endereço da área de memória atribuída é colocado onde este parâmetro aponta.
- **memory_size**: Número de bytes solicitados.
- **wait_option**: Define como o serviço se comporta se não houver memória suficiente disponível. As opções de espera são definidas da seguinte forma:
    - **TX_NO_WAIT:**(0x00000000)
    - **TX_WAIT_FOREVER:**(0xFFFFFFFF)
    - valor de tempo limite: (0x00000001 através de 0xFFFFFFFE)

    A seleção TX_NO_WAIT resulta numa devolução imediata deste serviço, independentemente de ter sido ou não bem sucedida. *Esta é a única opção válida se o serviço for chamado de inicialização.*

    A seleção TX_WAIT_FOREVER faz com que o fio de chamada suspenda indefinidamente até que a memória esteja disponível.

    Selecionar um valor numérico (1-0xFFFFFFFE) especifica o número máximo de temporizadores para permanecer suspenso enquanto espera pela memória.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS:**(0x00) Atribuição de memória bem sucedida.
- **TX_DELETED**: (0x01) O pool de memória foi apagado enquanto o fio foi suspenso.
- **TX_NO_MEMORY**: (0x10) O serviço não pôde alocar a memória dentro do tempo especificado para esperar.
- **TX_WAIT_ABORTED:**(0x1A) A suspensão foi abortada por outro fio, temporizador ou ISR.
...
- **pool_ptr**: Ponteiro para um bloco de controlo da piscina de memória.
- **name_ptr**: Pontear o nome do pool de memória.
...
- **nome**: Ponteiro para destino para o ponteiro para o nome da piscina byte.
- **disponível**: Ponteiro para destino para o número de bytes disponíveis na piscina.
- **fragmentos**: Ponteiro para o destino para o número total de fragmentos de memória na piscina byte.
- **first_suspended**: Ponter para o destino para o ponteiro para o fio que é o primeiro na lista de suspensão deste byte pool.
- **suspended_count**: Ponter para o destino para o número de fios atualmente suspensos nesta piscina byte.
- **next_pool**: Ponte para o destino para o ponteiro da próxima piscina byte criada.
...
- **TX_SUCCESS:**(0x00) Recuperação de informações de piscinas bem sucedidas.
- TX_POOL_ERROR: (0x02) Ponteiro do piscina de memória inválido.
...
> [!IMPORTANT]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_BYTE_POOL_ENABLE_PERFORMANCE_INFO** definidas para este serviço devolver informações de desempenho.

### <a name="parameters"></a>Parâmetros

- **pool_ptr**: Ponteiro para piscina byte de memória previamente criada.
- **atribuições**: Ponteiro para destino para o número de pedidos de atribuição realizados nesta piscina.
- **lançamentos**: Ponteiro para o destino para o número de pedidos de libertação realizados nesta piscina.
- **fragments_searched**: Ponte rumo ao destino para o número de fragmentos de memória internos pesquisados durante os pedidos de atribuição nesta piscina.
- **fusões**: Ponteiro para destino para o número de blocos de memória internos fundidos durante os pedidos de atribuição neste pool.
...
- TX_SUCCESS: (0x00) Desempenho da piscina byte bem sucedido.
...
- **atribuições**: Ponteiro para destino para o número de pedidos de atribuição realizados nesta piscina.
- **lançamentos**: Ponteiro para o destino para o número de pedidos de libertação realizados nesta piscina.
- **fragments_searched**: Ponte rumo ao destino para o número total de fragmentos de memória internos pesquisados durante os pedidos de atribuição em todas as piscinas byte.
- **fusões**: Ponteiro para destino para o número total de blocos de memória internos fundidos durante os pedidos de atribuição em todas as piscinas byte.
...
- **suspensões**: Ponteiro para o destino para o número total de suspensões de atribuição de fios em todas as piscinas byte.
- **intervalos :** Ponteiro para o destino para o número total de intervalos de suspensão atribuídos em todas as piscinas byte.
...
- **memory_ptr**: Ponte para a área de memória previamente atribuída.
...
- TX_GROUP_ERROR: (0x06) Ponteiro do grupo de eventos inválido. Ou o ponteiro é NU OU o grupo de eventos já está criado.
- TX_CALLER_ERROR: (0x13) Inválido deste serviço.
...
- **group_ptr**: Pontear para um grupo de bandeiras de eventos previamente criado.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Eliminação de bandeiras de eventos bem-sucedidos.
- TX_GROUP_ERROR: (0x06) Inválido sinaliza ponteiro do grupo.
- TX_CALLER_ERROR: (0x13) Inválido deste serviço.
...
- **group_ptr**: Pontear para um grupo de bandeiras de eventos previamente criado.
- **requested_flags:** variável não assinada de 32 bits que representa as bandeiras do evento solicitadas.
- **get_option**: Especifica se são necessárias todas ou quaisquer das bandeiras de eventos solicitadas. Seguem-se as seguintes seleções válidas:
    - **TX_AND:**(0x02)
    - **TX_AND_CLEAR:**(0x03)
    - **TX_OR:**(0x00)
    - **TX_OR_CLEAR:**(0x01)
...
- **atual_flags_ptr**: Ponteiro para o destino de onde são colocadas as bandeiras do evento recuperado. Note-se que as bandeiras obtidas podem conter bandeiras que não foram solicitadas.
- **wait_option**: Define como o serviço se comporta se as bandeiras de eventos selecionadas não estiverem definidas. As opções de espera são definidas da seguinte forma:
    - **TX_NO_WAIT:**(0x00000000)
    - **TX_WAIT_FOREVER:**(0xFFFFFFFF)
    - valor de tempo limite: (0x00000001 através de 0xFFFFFFFE)

    A seleção TX_NO_WAIT resulta numa devolução imediata deste serviço, independentemente de ter sido ou não bem sucedida. Esta é a única opção válida se o serviço for chamado de uma não linha; por exemplo, Inicialização, temporizador ou ISR.

    A seleção TX_WAIT_FOREVER faz com que o fio de chamada suspenda indefinidamente até que as bandeiras do evento estejam disponíveis.

    A seleção de um valor numérico (1-0xFFFFFFFE) especifica o número máximo de temporizadores para permanecer suspenso enquanto se aguarda pelas bandeiras do evento.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Bandeiras de eventos bem sucedidas recebem.
- **TX_DELETED**: (0x01) O grupo de bandeiras de eventos foi apagado enquanto o fio foi suspenso.
- **TX_NO_EVENTS**: (0x07) O serviço não conseguiu obter os eventos especificados dentro do tempo especificado para esperar.
- **TX_WAIT_ABORTED:**(0x1A) A suspensão foi abortada por outro fio, temporizador ou ISR.
- TX_GROUP_ERROR: (0x06) Inválido sinaliza ponteiro do grupo.
- TX_PTR_ERROR: (0x03) Ponteiro inválido para bandeiras de eventos reais.
- TX_WAIT_ERROR: (0x04) Uma opção de espera que não TX_NO_WAIT foi especificada numa chamada de uma não-leitura.
...
- **group_ptr**: Ponteiro para um bloco de controlo de grupo de bandeiras de evento.
- **nome**: Ponteiro para o destino para o ponteiro para o nome do grupo de bandeiras do evento.
- **current_flags**: Ponteiro para o destino para as bandeiras atuais do grupo de bandeiras do evento.
- **first_suspended**: Ponter para o destino para o ponteiro para o fio que é o primeiro na lista de suspensão deste grupo de bandeiras de evento.
- **suspended_count**: Ponteiro para o destino para o número de fios atualmente suspensos neste grupo de bandeiras de evento.
- **next_group**: Ponter para o destino para o ponteiro do próximo grupo de bandeiras de eventos criado.
...
- TX_GROUP_ERROR: (0x06) Ponteiro do grupo de eventos inválido.
...
> [!IMPORTANT]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_EVENT_FLAGS_ENABLE_PERFORMANCE_INFO** definidas para este serviço devolver informações de desempenho.
...
- **recebe:** Ponteiro para destino para o número de bandeiras de eventos obter pedidos realizados neste grupo.
- **suspensões**: Ponteiro para o destino para o número de bandeiras de eventos thread obter suspensões neste grupo.
- **intervalos :** Ponteiro para o destino para o número de bandeiras de eventos obter intervalos de suspensão neste grupo.
...
- **conjuntos**: Ponteiro para destino para o número total de pedidos de conjunto de bandeiras de eventos realizados em todos os grupos.
- **recebe:** Ponteiro para destino para o número total de bandeiras de eventos obter pedidos realizados em todos os grupos.
- **suspensões**: Ponteiro para destino para o número total de bandeiras de eventos de fio obter suspensões em todos os grupos.
- **intervalos :** Ponteiro para o destino para o número total de bandeiras de eventos obtém intervalos de suspensão em todos os grupos.
...
- **TX_SUCCESS**: (0x00) O desempenho do sistema de bandeiras de eventos bem sucedido.
- **TX_FEATURE_NOT_ENABLED**: (0xFF) O sistema não foi compilado com informações de desempenho ativadas.
...
- **group_ptr**: Ponteiro para o bloco de controlo de grupo de bandeiras de eventos previamente criado.
- **flags_to_set**: Especifica as bandeiras do evento para definir ou limpar com base na opção definida selecionada.
- **set_option**: Especifica se as bandeiras do evento especificadas são ANDed ou ORed nas atuais bandeiras do grupo. Seguem-se as seguintes seleções válidas:
    - **TX_AND:**(0x02)
    - **TX_OR**: (0x00) A seleção TX_AND especifica que as bandeiras de eventos especificadas são **especadas** nas atuais bandeiras do evento no grupo. Esta opção é frequentemente usada para limpar bandeiras de eventos em um grupo. Caso contrário, se TX_OR for especificado, as bandeiras de eventos especificadas são **ORed** com o evento atual no grupo.
...
- TX_OPTION_ERROR: (0x08) A opção de set inválida especificada.
...
> [!NOTE]
> As bandeiras de evento da aplicação configuram a chamada de notificação não é permitida a chamada de API da ThreadX SMP com uma opção de suspensão.

### <a name="parameters"></a>Parâmetros 
- **group_ptr**: Ponteiro para grupo de bandeiras de eventos previamente criado.
- **events_set_notify**: Ponteiro para as bandeiras de eventos da aplicação definir função de notificação. Se este valor for TX_NULL, a notificação é desativada.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Registo bem sucedido de bandeiras de eventos de notificação definida.
- TX_GROUP_ERROR: (0x06) Inválido sinaliza ponteiro do grupo.
...
- **new_posture**: Este parâmetro especifica se as interrupções estão desativadas ou ativadas. Os valores legais incluem **TX_INT_DISABLE e TX_INT_ENABLE.** Os valores reais para estes parâmetros são específicos do porto. Além disso, algumas arquiteturas de processamento podem suportar posturas adicionais de interrupção de desativação. Consulte as **_informaçõesreadme_threadx.txt_** fornecidas no disco de distribuição para mais detalhes.
...
- **mutex_ptr**: Ponter para um bloco de controlo de mutantes.
- **name_ptr**: Ponteiro para o nome do mutex.
...
- **mutex_ptr**: Ponteiro para um mutex previamente criado.
...
- **mutex_ptr**: Ponteiro para um mutex previamente criado.
- **wait_option**: Define como o serviço se comporta se o mutex já é propriedade de outro fio. As opções de espera são definidas da seguinte forma:
    - **TX_NO_WAIT:**(0x00000000)
    - **TX_WAIT_FOREVER:**(0xFFFFFFFF)
    - valor de tempo limite: (0x00000001 através de 0xFFFFFFFE)

    A seleção TX_NO_WAIT resulta numa devolução imediata deste serviço, independentemente de ter sido ou não bem sucedida. *Esta é a única opção válida se o serviço for chamado da Initialization.*

    A seleção TX_WAIT_FOREVER faz com que o fio de chamada suspenda indefinidamente até que o mutex esteja disponível.

    Selecionar um valor numérico (1-0xFFFFFFFE) especifica o número máximo de temporizadores para permanecer suspenso enquanto espera pelo mutex.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS:**(0x00) Operação mutex com sucesso.
- **TX_DELETED**: (0x01) A Mutex foi eliminada enquanto o fio foi suspenso.
- **TX_NOT_AVAILABLE**: (0x1D) O serviço não foi capaz de obter a propriedade do mutex dentro do tempo especificado para esperar.
- **TX_WAIT_ABORTED:**(0x1A) A suspensão foi abortada por outro fio, temporizador ou ISR.
- TX_MUTEX_ERROR: (0x1C) Ponteiro mutex inválido.
- TX_WAIT_ERROR: (0x04) Uma opção de espera que não TX_NO_WAIT foi especificada numa chamada de uma não-leitura.
- TX_CALLER_ERROR: (0x13) Inválido deste serviço.
...
- **nome**: Ponteiro para destino para o ponteiro para o nome do mutex.
- **contagem**: Ponteiro para destino para a contagem de propriedade do mutex.
- **proprietário**: Ponteiro para destino para o ponteiro do fio proprietário.
- **first_suspended**: Ponter para o destino para o ponteiro para o fio que é o primeiro na lista de suspensão deste mutex.
- **suspended_count**: Ponter para o destino para o número de fios atualmente suspensos neste mutex.
- **next_mutex**: Ponte para o destino para o ponteiro do mutex criado seguinte.
...
- **TX_SUCCESS**: (0x00) Recuperação bem sucedida de informação sobre mutantes.
- TX_MUTEX_ERROR: (0x1C) Ponteiro mutex inválido.
...
> [!IMPORTANT]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_MUTEX_ENABLE_PERFORMANCE_INFO** definidas para este serviço devolver informações de desempenho.

### <a name="parameters"></a>Parâmetros

- **mutex_ptr**: Ponteiro para o mutex previamente criado.
- **coloca:** Ponteiro para destino para o número de pedidos de colocação realizados neste mutex.
...
- **intervalos :** Ponte para o destino para o número de mutaex obter intervalos de suspensão neste mutex.
...
- **colocações**: Ponteiro para destino para o número total de pedidos de colocação realizados em todos os mutaxos.
- **recebe:** Ponteiro para destino para o número total de pedidos de get realizados em todos os mutaxos.
- **suspensões**: Ponteiro para destino para o número total de mutantes de fio obter suspensões em todos os mutais.
- **intervalos :** Ponteiro para o destino para o número total de mutantes obtenha intervalos de suspensão em todos os mutaxos.
...
- **TX_SUCCESS**: (0x00) O desempenho do sistema mutex com sucesso obtém.
- **TX_FEATURE_NOT_ENABLED**: (0xFF) O sistema não foi compilado com informações de desempenho ativadas.
...
- **mutex_ptr**: Ponte para o mutex previamente criado.
...
- **queue_ptr**: Pontear para um bloco de controlo da fila de mensagens.
- **name_ptr**: Pontear o nome da fila da mensagem.
...
> [!IMPORTANT]
> O pedido deve certificar-se de que qualquer pedido de notificação para esta fila está concluído (ou desativado) antes de apagar a fila. Além disso, a aplicação deve impedir qualquer utilização futura de uma fila eliminada.

*É também da responsabilidade da aplicação gerir a área de memória associada à fila, que está disponível após a conclusão deste serviço.*

### <a name="parameters"></a>Parâmetros 

- **queue_ptr**: Pontear para uma fila de mensagens previamente criada.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Eliminação bem sucedida da fila da mensagem.
...
- **TX_SUCCESS**: (0x00) Flush de fila de mensagens bem sucedidas.
- TX_QUEUE_ERROR: (0x09) Ponteiro de fila de mensagens inválidas.
...
- **queue_ptr**: Pontear para um bloco de controlo da fila de mensagens.
- **source_ptr**: Ponte para a mensagem.
- **wait_option**: Define como o serviço se comporta se a fila da mensagem estiver cheia. As opções de espera são definidas da seguinte forma:
    - **TX_NO_WAIT:**(0x00000000)
    - **TX_WAIT_FOREVER:**(0xFFFFFFFF)
    - valor de tempo limite: (0x00000001 através de 0xFFFFFFFE)
    ...
    A seleção TX_WAIT_FOREVER faz com que o fio de chamada suspenda indefinidamente até que haja espaço na fila.

    Selecionar um valor numérico (1-0xFFFFFFFE) especifica o número máximo de temporizadores para permanecer suspenso enquanto espera por espaço na fila.
...
- **queue_ptr**: Pontear para uma fila de mensagens previamente criada.
- **nome**: Ponteiro para destino para o ponteiro para o nome da fila.
- **encadeado**: Ponteiro para destino para o número de mensagens atualmente na fila.
- **available_storage**: Ponte para o destino para o número de mensagens para as seguintes.
- **first_suspended**: Ponter para o destino para o ponteiro para o fio que é o primeiro na lista de suspensão desta fila.
- **suspended_count**: Ponter para o destino para o número de fios atualmente suspensos nesta fila.
- **next_queue**: Ponte para o destino para o ponteiro da próxima fila criada.
...
- **TX_SUCCESS:**(0x00) Obter informações de fila bem sucedidas.
- TX_QUEUE_ERROR: (0x09) Ponteiro de fila de mensagens inválidas.
...
> [!IMPORTANT]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_QUEUE_ENABLE_PERFORMANCE_INFO** definidas para este serviço devolver informações de desempenho.

### <a name="parameters"></a>Parâmetros

- **queue_ptr**: Ponteiro para fila previamente criada.
- **messages_sent**: Ponte para o destino para o número de pedidos de envio realizados nesta fila.
- **messages_received**: Ponteiro para o destino para o número de pedidos de receção realizados nesta fila.
- **empty_suspensions**: Ponte para o destino para o número de suspensões vazias de fila nesta fila.
- **full_suspensions**: Ponte para o destino para o número de suspensões completas da fila nesta fila.
- **full_errors**: Ponte para o destino para o número de erros completos da fila nesta fila.
- **intervalos :** Ponte para o destino para o número de intervalos de suspensão de fio nesta fila.
...
- **messages_sent**: Ponter para o destino para o número total de pedidos de envio realizados em todas as filas.
- **messages_received**: Ponteiro para o destino para o número total de pedidos de receção realizados em todas as filas.
- **empty_suspensions**: Ponte para o destino para o número total de suspensões vazias de fila em todas as filas.
- **full_suspensions**: Ponte para o destino para o número total de suspensões completas da fila em todas as filas.
- **full_errors**: Ponte para o destino para o número total de erros completos da fila em todas as filas.
- **intervalos :** Ponte para o destino para o número total de intervalos de suspensão de fio em todas as filas.
...
- **TX_SUCCESS**: (0x00) O desempenho do sistema de fila bem sucedido obtém.
- **TX_FEATURE_NOT_ENABLED**: (0xFF) O sistema não foi compilado com informações de desempenho ativadas.
...
- **TX_SUCCESS**: (0x00) Prioridades de fila bem sucedidas.
- TX_QUEUE_ERROR: (0x09) Ponteiro de fila de mensagens inválidas.
...
- **queue_ptr**: Pontear para uma fila de mensagens previamente criada.
- **destination_ptr:** Local de onde copiar a mensagem.
- **wait_option**: Define como o serviço se comporta se a fila da mensagem estiver vazia. As opções de espera são definidas da seguinte forma:
    - **TX_NO_WAIT:**(0x00000000) 
    - **TX_WAIT_FOREVER:**(0xFFFFFFFF) 
    - valor de tempo limite: (0x00000001 através de 0xFFFFFFFE)
    ...
    A seleção TX_WAIT_FOREVER faz com que o fio de chamada suspenda indefinidamente até que uma mensagem esteja disponível.

    Selecionar um valor numérico (1-0xFFFFFFFE) especifica o número máximo de temporizadores para permanecer suspenso enquanto se aguarda por uma mensagem.
...
> [!NOTE]
> A chamada de notificação de envio de fila da aplicação não está autorizada a ligar para qualquer API ThreadX SMP com uma opção de suspensão.
...
- **semaphore_ptr**: Ponteiro para semáforo previamente criado.
...
- **semaphore_ptr**: Ponter para um bloco de controlo de semáforos. 
- **name_ptr**: Ponte para o nome do semáforo.
...
- **semaphore_ptr**: Ponte para um semáforo previamente criado.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Eliminação de semáforos de contagem bem sucedida.
- TX_SEMAPHORE_ERROR: (0x0C) Ponteiro semáforo de contagem inválida.
- TX_CALLER_ERROR: (0x13) Inválido deste serviço.
...
- **semaphore_ptr**: Ponteiro para um semáforo de contagem previamente criado.
- **wait_option**: Define como o serviço se comporta se não houver casos do semáforo disponível; ou seja, a contagem de semáforos é zero. As opções de espera são definidas da seguinte forma:
    - **TX_NO_WAIT:**(0x00000000)
    - **TX_WAIT_FOREVER:**(0xFFFFFFFF)
    - valor de tempo limite: (0x00000001 através de 0xFFFFFFFE)
    ...
    A seleção TX_WAIT_FOREVER faz com que o fio de chamada suspenda indefinidamente até que esteja disponível uma instância de semáforo. 

    A seleção de um valor numérico (1-0xFFFFFFFE) especifica o número máximo de temporizadores para permanecer suspenso enquanto se aguarda por uma instância de semáforo.
...
- **nome**: Ponteiro para destino para o ponteiro para o nome do semáforo.
- **current_value**: Ponte para o destino para a contagem atual do semáforo.
- **first_suspended**: Ponter para o destino para o ponteiro para o fio que é o primeiro na lista de suspensão deste semáforo.
- **suspended_count**: Ponter para o destino para o número de fios atualmente suspensos neste semáforo.
- **next_semaphore**: Ponte para o destino para o ponteiro do próximo semáforo criado.
...
- **TX_SUCCESS**: (0x00) Recuperação de informações de semáforos bem sucedidos.
- TX_SEMAPHORE_ERROR: (0x0C) Ponteiro semáforo inválido.
...
> [!NOTE]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_SEMAPHORE_ENABLE_PERFORMANCE_INFO** definidas para este serviço devolver informações de desempenho.

### <a name="parameters"></a>Parâmetros

- **semaphore_ptr**: Ponteiro para semáforo previamente criado.
- **coloca:** Ponteiro para destino para o número de pedidos de colocação realizados neste semáforo.
- **recebe:** Ponteiro para destino para o número de pedidos de get realizados neste semáforo.
- **suspensões**: Ponteiro para o destino para o número de suspensões de rosca neste semáforo.
- **intervalos :** Ponte para o destino para o número de intervalos de suspensão de fio neste semáforo.
...
- **colocações**: Ponteiro para destino para o número total de pedidos de colocação realizados em todos os semáforos.
- **recebe:** Ponteiro para destino para o número total de pedidos de get realizados em todos os semáforos.
- **suspensões**: Ponteiro para o destino para o número total de suspensões de roscas em todos os semáforos.
- **intervalos :** Ponte para o destino para o número total de intervalos de suspensão de fio em todos os semáforos.
...
- TX_SUCCESS: (0x00) O desempenho do sistema de semáforos bem sucedido obtém.
- **TX_FEATURE_NOT_ENABLED**: (0xFF) O sistema não foi compilado com informações de desempenho ativadas.
...
- **TX_SUCCESS**: (0x00) Priorização do semáforo bem sucedido.
- TX_SEMAPHORE_ERROR: (0x0C) Ponteiro semáforo de contagem inválida.
...
- **semaphore_ptr**: Ponte para o bloco de controlo de semáforos previamente criado.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS:**(0x00) Semaphore bem sucedido colocado.
- TX_SEMAPHORE_ERROR: (0x0C) Ponteiro inválido à contagem de semáforos.
...
> [!NOTE]
> A chamada de notificação de semáforo da aplicação não está autorizada a ligar para a API da ThreadX SMP com uma opção de suspensão.
...
- **stack_size**: Bytes de números na área da memória da pilha. A área da pilha do fio deve ser grande o suficiente para lidar com a sua pior função de nidificação de chamadas e uso variável local.
...
- **preempt_threshold**: Nível de prioridade mais elevado (0 a TX_MAX_PRIORITIES-1)) de preempção deficiente. Apenas prioridades superiores a este nível são permitidas para antecipar este fio. Este valor deve ser inferior ou igual à prioridade especificada. Um valor igual à prioridade do fio desativa o limiar de pré-substituição.
- **time_slice**: O número de carraças-temporizador que este fio pode ser executado antes que outros fios prontos da mesma prioridade sejam autorizados a correr. Note que a utilização do limiar de pré-substituição desativa o corte de tempo. Os valores legais de corte de tempo variam de 1 a 0xFFFFFFFF (inclusive). Um valor de **TX_NO_TIME_SLICE** (um valor de 0) desativa o corte de tempo deste fio.
...
- **thread_ptr**: Pontear para um fio de aplicação previamente criado.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Supressão de rosca bem sucedida.
...
> [!NOTE]
> A chamada de notificação de entrada/saída da aplicação não está autorizada a ligar para a API da ThreadX SMP com uma opção de suspensão.
...
- ponteiro de linha: Ponteiro para o fio atualmente executado. Se não houver fio, o valor de retorno é TX_NULL.
...
- **thread_ptr**: Ponteiro para o bloco de controlo da rosca.
- **nome**: Ponteiro para destino para o ponteiro para o nome do fio.
- **estado**: Ponteiro para destino para o estado de execução atual do fio. Os valores possíveis são:
    - **TX_READY:**(0x00)
    - **TX_COMPLETED:**(0x01)
    - **TX_TERMINATED:**(0x02)
    - **TX_SUSPENDED:**(0x03)
...
- **run_count**: Ponter para o destino para a contagem de corridas do fio. 
- **prioridade**: Ponter para o destino para a prioridade da linha.
- **preemption_threshold**: Ponter para o destino para o limiar de pré-substituição do fio.
- **time_slice**: Ponter para o destino para a fatia de tempo do fio. 
- **next_thread**: Ponteiro para destino para o próximo ponteiro de linha criado.
- **suspended_thread**: Ponter para o destino para ponter o próximo fio na lista de suspensão.
...
> [!IMPORTANT]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_THREAD_ENABLE_PERFORMANCE_INFO** definidas para que este serviço devolva informações de desempenho.

### <a name="parameters"></a>Parâmetros 

- **thread_ptr**: Ponteiro para fio previamente criado.
- **resturações**: Ponteiro para o destino para o número de resturações deste fio.
- **suspensões**: Ponteiro para o destino para o número de suspensões deste fio.
- **solicited_preemptions**: Ponter para o destino para o número de preventivas como resultado de uma chamada de serviço API threadX feita por este fio.
- **interrupt_preemptions**: Ponter para o destino para o número de preventivas deste fio como resultado do processamento de interrupção.
- **priority_inversions**: Ponteiro para o destino para o número de inversões prioritárias deste fio.
- **time_slices**: Ponte para o destino para o número de tempolices deste fio.
- **renuncia:** Ponteiro para destino para o número de renúncias de fio realizadas por este fio.
- **intervalos :** Ponte para o destino para o número de intervalos de suspensão neste fio.
- **wait_aborts**: Ponter para o destino para o número de abortos de espera realizados neste fio.
- **last_preempted_by**: Ponter para o destino para o ponteiro de linha que por último preemptou este fio.
...
- **resturações**: Ponteiro para o destino para o número total de reposições de roscas.
- **suspensões**: Ponteiro para o destino para o número total de suspensões de rosca.
- **solicited_preemptions**: Ponter para o destino para o número total de preempções de fio como resultado de um fio que chama um serviço API ThreadX.
- **interrupt_preemptions**: Ponter para o destino para o número total de preemposições de rosca como resultado do processamento de interrupção.
- **priority_inversions**: Ponteiro para o destino para o número total de inversões prioritárias de linha.
- **time_slices**: Ponter para o destino para o número total de fatias de tempo de fio.
...
- **wait_aborts**: Ponter para o destino para o número total de abortos de espera de fio. 
- **non_idle_returns**: Ponter para o destino para o número de vezes que um fio retorna ao sistema quando outro fio estiver pronto para ser executado. 
- **idle_returns**: Ponter para o destino para o número de vezes que um fio retorna ao sistema quando nenhum outro fio está pronto para ser executado (sistema inativo).
...
- **TX_SUCCESS**: (0x00) Obtém-se um desempenho bem sucedido do sistema de fio.
- **TX_FEATURE_NOT_ENABLED**: (0xFF) O sistema não foi compilado com informações de desempenho ativadas.
...
- **old_threshold**: Ponter para um local para devolver o limiar de pré-substituição anterior.
...
> [!IMPORTANT]
> O limiar de pré-substituição do fio especificado é automaticamente definido para a nova prioridade. Se for desejado um novo limiar, o serviço **tx_thread_preemption_change** deve ser utilizado após esta chamada.

### <a name="parameters"></a>Parâmetros

- **thread_ptr**: Pontear para um fio de aplicação previamente criado.
- **new_priority**: Novo nível de prioridade do fio (0 a TX_MAX_PRIORITIES-1)).
- **old_priority**: Ponter para um local para devolver a prioridade anterior da linha.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Alteração prioritária bem sucedida.
- TX_THREAD_ERROR: (0x0E) Ponteiro de linha de aplicação inválido.
...
- **thread_ptr**: Pontear para um fio previamente criado.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS**: (0x00) Reset de fio bem sucedido.
- **TX_NOT_DONE**: (0x20) O fio especificado não se encontra num estado TX_COMPLETED ou TX_TERMINATED.
- TX_THREAD_ERROR: (0x0E) Ponteiro de rosca inválido.
- TX_CALLER_ERROR: (0x13) Inválido deste serviço.
...
- **thread_ptr**: Ponter para um fio de aplicação suspenso.
...
- **timer_ticks**: O número de carraças do temporizador para suspender o fio da aplicação de chamada, que varia de 0 a 0xFFFFFFFF. Se 0 for especificado, o serviço retorna imediatamente.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS:**(0x00) Sono de rosca bem sucedido.
- **TX_WAIT_ABORTED:**(0x1A) A suspensão foi abortada por outro fio, temporizador ou ISR.
- **TX_CALLER_ERROR**: (0x13) Serviço chamado de um não-fio.
...
Exclua a execução de fios num conjunto de núcleos
...
> [!IMPORTANT]
> A utilização da exclusão do processador pode causar um processamento adicional na linha para a lógica de mapeamento do núcleo, a fim de encontrar a correspondência ideal. Este processamento é limitado pelo número de fios prontos.

### <a name="parameters"></a>Parâmetros 

- **thread_ptr**: Ponteiro para roscar para alterar a exclusão do núcleo.
- **exclusion_map:** Mapa de bits onde um pouco de assento indica que esse núcleo está excluído. O fornecimento de um valor de 0 permite que o fio seja executado em qualquer núcleo (predefinição).

### <a name="return-values"></a>Valores de devolução

- TX_SUCCESS: (0x00) Exclusão do núcleo bem sucedido.
- TX_THREAD_ERROR: (0x0E) Ponteiro de rosca inválido.

### <a name="allowed-from"></a>Permitido a partir de

Inicialização, ISRs, fios e temporizadores
...
Obtém a exclusão atual do núcleo do fio
...
- **thread_ptr**: Ponteiro para roscar a partir do qual recuperar a exclusão do núcleo.
- **exclusion_map_ptr**: Destino para o mapa atual do bit de exclusão do núcleo.

### <a name="return-values"></a>Valores de devolução

- TX_SUCCESS: (0x00) Recuperação bem sucedida da exclusão do núcleo do thread.
- TX_THREAD_ERROR: (0x0E) Ponteiro de rosca inválido.
- TX_PTR_ERROR: (0x03) Ponteiro de destino de exclusão inválida.
...
Recupere atualmente o núcleo de execução do chamador
...
- core_id: ID de execução atual do núcleo(0 a TX_THREAD_SMP_MAX_CORES-1)
...
> [!IMPORTANT]
> A biblioteca ThreadX SMP deve ser construída com **TX_ENABLE_STACK_CHECKING** definidas para que este serviço devolva informações de desempenho.
...
- **TX_SUCCESS**: (0x00) Suspensão de fio bem sucedida.
- TX_THREAD_ERROR: (0x0E) Ponteiro de linha de aplicação inválido.
...
- **thread_ptr**: Ponteiro para o fio da aplicação.

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS:**(0x00) Fim de fio bem sucedido.
- TX_THREAD_ERROR: (0x0E) Ponteiro de linha de aplicação inválido.
- TX_CALLER_ERROR: (0x13) Inválido deste serviço.
...
- **old_time_slice**: Ponteiro para a localização para armazenar o valor de 200 horas anteriores do fio especificado.
...
- tiques do relógio do sistema: Valor do relógio interno, livre, do sistema.
...
- **new_time**: Nova hora para colocar no relógio do sistema, os valores legais variam de 0 a 0xFFFFFFFF.
...
> [!NOTE]
> Que um temporizador de um tiro expirado deve ser reiniciado através **de tx_timer_change** antes de poder ser ativado novamente.
...
- **TX_ACTIVATE_ERROR**: (0x17) O temporizador já estava ativo ou é um temporizador de um tiro que já expirou.
...
> [!IMPORTANT]
> É necessária uma chamada para o serviço **tx_timer_activate** após este serviço para repor o temporizador.
...
- **reschedule_ticks**: Especifica o número de carraças para todos os expiradores do temporizador após o primeiro. Um zero para este parâmetro faz do temporizador um temporizador de um tiro. Caso contrário, para os temporizadores periódicos, os valores legais variam de 1 a 0xFFFFFFFF.
...
- **TX_SUCCESS:**(0x00) Alteração do temporizador de aplicação bem sucedida.
- TX_TIMER_ERROR: (0x15) Ponteiro do temporizador de aplicação inválido.
...
- **timer_ptr**: Ponteiro para um bloco de controlo do temporizador
- **name_ptr**: Ponter o nome do temporizador.
- **expiration_function**: Função de aplicação para ligar quando o temporizador expirar.
- **expiration_input:** Inserir para passar para a função de expiração quando o temporizador expirar.
- **initial_ticks**: Especifica o número inicial de carraças para a expiração do temporizador. Os valores legais variam de 1 a 0xFFFFFFFF.
- **reschedule_ticks**: Especifica o número de carraças para todos os expiradores do temporizador após o primeiro. Um zero para este parâmetro faz do temporizador um temporizador de um tiro. Caso contrário, para os temporizadores periódicos, os valores legais variam de 1 a 0xFFFFFFFF.
...
- **timer_ptr**: Ponteiro para um temporizador de aplicação previamente criado.
- **nome**: Ponteiro para destino para o ponteiro para o nome do temporizador.
- **ativo**: Ponteiro para destino para a indicação ativa do temporizador. Se o temporizador estiver inativo ou este serviço for chamado do temporizador em si, é devolvido um valor TX_FALSE. Caso contrário, se o temporizador estiver ativo, é devolvido um valor TX_TRUE.
- **remaining_ticks**: Ponter para o destino para o número de carraças de temporizador que sobrou antes do temporizador expirar.
- **reschedule_ticks**: Ponter para o destino para o número de carraças tempores que serão usadas para reagendar automaticamente este temporizador. Se o valor for zero, então o temporizador é um tiro e não será reagendado.
- **next_timer**: Ponter para o destino para o ponteiro do temporizador de aplicação criado seguinte.
...
- **TX_SUCCESS**: (0x00) Recuperação de informações de temporizador bem sucedida.
- TX_TIMER_ERROR: (0x15) Ponteiro do temporizador de aplicação inválido.
...
> [!IMPORTANT]
> A biblioteca e aplicação ThreadX SMP devem ser construídas com **TX_TIMER_ENABLE_PERFORMANCE_INFO** definidas para este serviço devolver informações de desempenho.

### <a name="parameters"></a>Parâmetros 

- **timer_ptr**: Ponteiro para temporizador previamente criado.
- **activa-** Ponteiro para destino para o número de pedidos de ativação realizados neste temporizador.
- **reativa:** Ponteiro para o destino para o número de reativações automáticas efetuadas neste temporizador periódico.
- **desativa**: Ponteiro para o destino para o número de pedidos de desativação realizados neste temporizador.
- **expirações**: Ponteiro para o destino para o número de expirações deste temporizador.
- **expiration_adjusts**: Ponteiro para o destino para o número de ajustes internos de validade realizados neste temporizador. Estes ajustes são efetuados no temporizador interrompem o processamento para temporizadores que são maiores do que o tamanho da lista de temporizadores predefinidos (por temporizadores predefinidos com prazos superiores a 32 carraças).
...
- **activa-** Ponteiro para destino para o número total de pedidos de ativação realizados em todos os temporizadores.
- **reativa:** Ponteiro para o destino para o número total de reativação automática efetuada em todos os temporizadores periódicos.
- **desativa**: Ponteiro para destino para o número total de pedidos de desativação realizados em todos os temporizadores.
- **expirações**: Ponteiro para o destino para o número total de expirações em todos os temporizadores.
- **expiration_adjusts**: Ponter para o destino para o número total de ajustes internos de validade realizados em todos os temporizadores. Estes ajustes são efetuados no temporizador interrompem o processamento para temporizadores que são maiores do que o tamanho da lista de temporizadores predefinidos (por temporizadores predefinidos com prazos superiores a 32 carraças).
...
- **TX_SUCCESS**: (0x00) Obtém-se um desempenho do sistema do sistema do temporizador de sucesso.
- **TX_FEATURE_NOT_ENABLED**: (0xFF) O sistema não foi compilado com informações de desempenho ativadas.
...
Excluir a execução do temporizador num conjunto de núcleos
...
- **timer_ptr**: Ponteiro para temporizador para alterar a exclusão do núcleo.
- **exclusion_map:** Mapa de bits onde um pouco de assento indica que esse núcleo está excluído. O fornecimento de um valor de 0 permite que o temporizador execute em qualquer núcleo (predefinição).

### <a name="return-values"></a>Valores de devolução

- **TX_SUCCESS** (0x00) Exclusão do núcleo bem sucedido.
- **TX_TIMER_ERROR** (0x0E) Ponteiro temporizador inválido.
...
Obtém a exclusão atual do núcleo do temporizador
...
- **timer_ptr**: Ponteiro para temporizador a partir do qual recuperar a exclusão do núcleo.
- **exclusion_map_ptr**: Destino para o mapa atual do bit de exclusão do núcleo.

### <a name="return-values"></a>Valores de devolução

- TX_SUCCESS: (0x00) Recuperação bem sucedida da exclusão do núcleo do temporizador.
- TX_TIMER_ERROR: (0x0E) Ponteiro temporizador inválido.
- TX_PTR_ERROR: (0x03) Ponteiro de destino de exclusão inválida.
