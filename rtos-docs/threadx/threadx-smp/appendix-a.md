---
title: Apêndice A - Azure RTOS ThreadX SMP API Services
description: Serviços API da ThreadX SMP
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104827343"
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a><span data-ttu-id="56da0-103">Apêndice A - Azure RTOS ThreadX SMP API Services</span><span class="sxs-lookup"><span data-stu-id="56da0-103">Appendix A - Azure RTOS ThreadX SMP API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="56da0-104">Função de entrada</span><span class="sxs-lookup"><span data-stu-id="56da0-104">Entry Function</span></span>

```C
VOID     tx_kernel_enter(VOID);
```
## <a name="block-memory-services"></a><span data-ttu-id="56da0-105">Bloquear serviços de memória</span><span class="sxs-lookup"><span data-stu-id="56da0-105">Block Memory Services</span></span>
...
```
## <a name="byte-memory-services"></a><span data-ttu-id="56da0-106">Serviços de Memória Byte</span><span class="sxs-lookup"><span data-stu-id="56da0-106">Byte Memory Services</span></span>
...
```
## <a name="event-flags-services"></a><span data-ttu-id="56da0-107">Serviços de Bandeiras de Eventos</span><span class="sxs-lookup"><span data-stu-id="56da0-107">Event Flags Services</span></span>
...
UINT     tx_event_flags_set_notify(TX_EVENT_FLAGS_GROUP
            ...
            *));
```
## <a name="interrupt-control"></a><span data-ttu-id="56da0-108">Controlo de Interrupção</span><span class="sxs-lookup"><span data-stu-id="56da0-108">Interrupt Control</span></span>

```C
UINT     tx_interrupt_control(UINT new_posture);
```
## <a name="mutex-services"></a><span data-ttu-id="56da0-109">Serviços Mutex</span><span class="sxs-lookup"><span data-stu-id="56da0-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="56da0-110">Serviços de fila</span><span class="sxs-lookup"><span data-stu-id="56da0-110">Queue Services</span></span>
...
```
## <a name="semaphore-services"></a><span data-ttu-id="56da0-111">Serviços Semáforos</span><span class="sxs-lookup"><span data-stu-id="56da0-111">Semaphore Services</span></span>
...
UINT     tx_semaphore_put_notify(TX_SEMAPHORE
            ...
            *));
```
## <a name="thread-control-services"></a><span data-ttu-id="56da0-112">Serviços de Controlo de Fios</span><span class="sxs-lookup"><span data-stu-id="56da0-112">Thread Control Services</span></span>
...
```
## <a name="time-services"></a><span data-ttu-id="56da0-113">Serviços de Tempo</span><span class="sxs-lookup"><span data-stu-id="56da0-113">Time Services</span></span>

```C
ULONG     tx_time_get(VOID);
VOID      tx_time_set(ULONG new_time);
```
## <a name="timer-services"></a><span data-ttu-id="56da0-114">Serviços de temporizador</span><span class="sxs-lookup"><span data-stu-id="56da0-114">Timer Services</span></span>
