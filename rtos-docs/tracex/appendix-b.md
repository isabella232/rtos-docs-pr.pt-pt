---
title: Apêndice B - O ficheiro tx_trace.h
description: Este capítulo apresenta o ficheiro tx_trace.h.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104827829"
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="fc268-103">Apêndice B - O ficheiro tx_trace.h</span><span class="sxs-lookup"><span data-stu-id="fc268-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="fc268-104">Este capítulo apresenta o ficheiro **tx_trace.h.**</span><span class="sxs-lookup"><span data-stu-id="fc268-104">This chapter displays the **tx_trace.h** file.</span></span>
