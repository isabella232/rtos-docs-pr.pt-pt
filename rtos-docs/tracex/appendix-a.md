---
title: Apêndice A - Amostra tx_port.h
description: Este capítulo apresenta uma amostra tx_port.h.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104827848"
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="fcf23-103">Apêndice A - Amostra tx_port.h</span><span class="sxs-lookup"><span data-stu-id="fcf23-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="fcf23-104">Este capítulo apresenta uma amostra **tx_port.h.**</span><span class="sxs-lookup"><span data-stu-id="fcf23-104">This chapter displays a sample **tx_port.h** file.</span></span>
