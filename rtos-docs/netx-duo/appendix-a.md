---
title: Apêndice A - Azure RTOS NetX Duo Services
description: Saiba mais sobre os Serviços Azure RTOS NetX Duo.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104827049"
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a><span data-ttu-id="9593a-103">Apêndice A - Azure RTOS NetX Duo Services</span><span class="sxs-lookup"><span data-stu-id="9593a-103">Appendix A - Azure RTOS NetX Duo Services</span></span>

## <a name="address-resolution-protocol-arp"></a><span data-ttu-id="9593a-104">Protocolo de Resolução de Endereços (ARP)</span><span class="sxs-lookup"><span data-stu-id="9593a-104">Address Resolution Protocol (ARP)</span></span>  
...
## <a name="internet-control-message-protocol-icmp"></a><span data-ttu-id="9593a-105">Protocolo de mensagem de controlo da Internet (ICMP)</span><span class="sxs-lookup"><span data-stu-id="9593a-105">Internet Control Message Protocol (ICMP)</span></span>  
...
## <a name="internet-group-management-protocol-igmp"></a><span data-ttu-id="9593a-106">Protocolo de Gestão do Grupo de Internet (IGMP)</span><span class="sxs-lookup"><span data-stu-id="9593a-106">Internet Group Management Protocol (IGMP)</span></span>  
...
UINT     nx_igmp_multicast_leave(NX_IP *ip_ptr,
            ULONG group_address);
```
## <a name="internet-protocol-ip"></a><span data-ttu-id="9593a-107">Protocolo de Internet (IP)</span><span class="sxs-lookup"><span data-stu-id="9593a-107">Internet Protocol (IP)</span></span> 
...
## <a name="neighbor-discovery"></a><span data-ttu-id="9593a-108">Descoberta do Vizinho</span><span class="sxs-lookup"><span data-stu-id="9593a-108">Neighbor Discovery</span></span>  
...
## <a name="packet-management"></a><span data-ttu-id="9593a-109">Gestão de Pacotes</span><span class="sxs-lookup"><span data-stu-id="9593a-109">Packet Management</span></span>  
...
## <a name="reverse-address-resolution-protocol-rarp"></a><span data-ttu-id="9593a-110">Protocolo de Resolução de Endereços Reversos (RARP)</span><span class="sxs-lookup"><span data-stu-id="9593a-110">Reverse Address Resolution Protocol (RARP)</span></span>  
...
## <a name="system-management"></a><span data-ttu-id="9593a-111">Gestão de Sistema</span><span class="sxs-lookup"><span data-stu-id="9593a-111">System Management</span></span>  

```c
VOID     nx_system_initialize(VOID);
```

## <a name="transmission-control-protocol-tcp"></a><span data-ttu-id="9593a-112">Protocolo de Controlo de Transmissão (TCP)</span><span class="sxs-lookup"><span data-stu-id="9593a-112">Transmission Control Protocol (TCP)</span></span>  
...
## <a name="user-datagram-protocol-udp"></a><span data-ttu-id="9593a-113">Protocolo de Datagrama do Utilizador (UDP)</span><span class="sxs-lookup"><span data-stu-id="9593a-113">User Datagram Protocol (UDP)</span></span>  
