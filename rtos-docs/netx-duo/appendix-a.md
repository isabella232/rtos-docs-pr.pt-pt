...
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a>Apêndice A - Azure RTOS NetX Duo Services

## <a name="address-resolution-protocol-arp"></a>Protocolo de Resolução de Endereços (ARP)  
...
## <a name="neighbor-discovery"></a>Descoberta do Vizinho  
...
## <a name="packet-management"></a>Gestão de Pacotes  
...
## <a name="reverse-address-resolution-protocol-rarp"></a>Protocolo de Resolução de Endereços Reversos (RARP)  
