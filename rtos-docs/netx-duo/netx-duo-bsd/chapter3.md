---
title: Capítulo 3 - Azure RTOS NetX Duo BSD Services
description: Este capítulo contém uma descrição de todos os serviços básicos Azure RTOS NetX Duo BSD (listados abaixo) por ordem alfabética.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104826150"
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a><span data-ttu-id="74560-103">Capítulo 3 - Azure RTOS NetX Duo BSD Services</span><span class="sxs-lookup"><span data-stu-id="74560-103">Chapter 3 - Azure RTOS NetX Duo BSD Services</span></span>

<span data-ttu-id="74560-104">Este capítulo contém uma descrição de todos os serviços básicos Azure RTOS NetX Duo BSD (listados abaixo) por ordem alfabética.</span><span class="sxs-lookup"><span data-stu-id="74560-104">This chapter contains a description of all Azure RTOS NetX Duo BSD basic services (listed below) in alphabetic order.</span></span>
