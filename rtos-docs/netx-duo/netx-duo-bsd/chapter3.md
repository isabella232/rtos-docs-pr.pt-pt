...
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a>Capítulo 3 - Azure RTOS NetX Duo BSD Services

Este capítulo contém uma descrição de todos os serviços básicos Azure RTOS NetX Duo BSD (listados abaixo) por ordem alfabética.
