...
## <a name="configuration-options"></a><span data-ttu-id="a808a-117">Opções de configuração</span><span class="sxs-lookup"><span data-stu-id="a808a-117">Configuration Options</span></span>
