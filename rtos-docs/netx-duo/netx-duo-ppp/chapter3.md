...
- <span data-ttu-id="ca7e9-114">**nx_ppp_secondary_dns_address_set**: *Definir Secondary_DNS endereço IP do servidor*</span><span class="sxs-lookup"><span data-stu-id="ca7e9-114">**nx_ppp_secondary_dns_address_set**: *Set Secondary_DNS Server IP address*</span></span>
...
### <a name="prototype"></a><span data-ttu-id="ca7e9-131">Prototype</span><span class="sxs-lookup"><span data-stu-id="ca7e9-131">Prototype</span></span>
...
### <a name="allowed-from"></a><span data-ttu-id="ca7e9-160">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-160">Allowed From</span></span>
...
- <span data-ttu-id="ca7e9-184">**NX_SUCCESS**: (0x00) PPP CHAP bem sucedido</span><span class="sxs-lookup"><span data-stu-id="ca7e9-184">**NX_SUCCESS**: (0x00) Successful PPP CHAP enable</span></span>
...
<span data-ttu-id="ca7e9-193">Criar uma instância PPP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-193">Create a PPP instance</span></span>
...
<span data-ttu-id="ca7e9-220">Eliminar uma instância de PPP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-220">Delete a PPP instance</span></span>
...
## <a name="nx_ppp_dns_address_get"></a><span data-ttu-id="ca7e9-233">nx_ppp_dns_address_get</span><span class="sxs-lookup"><span data-stu-id="ca7e9-233">nx_ppp_dns_address_get</span></span>
...
<span data-ttu-id="ca7e9-247">Inicialização, fios, temporizadores, ISRs</span><span class="sxs-lookup"><span data-stu-id="ca7e9-247">Initialization, threads, timers, ISRs</span></span>
...
### <a name="return-values"></a><span data-ttu-id="ca7e9-258">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-258">Return Values</span></span>
...
## <a name="nx_ppp_secondary_dns_address_set"></a><span data-ttu-id="ca7e9-281">nx_ppp_secondary_dns_address_set</span><span class="sxs-lookup"><span data-stu-id="ca7e9-281">nx_ppp_secondary_dns_address_set</span></span>
...
<span data-ttu-id="ca7e9-295">Inicialização, fios</span><span class="sxs-lookup"><span data-stu-id="ca7e9-295">Initialization, threads</span></span>
...
### <a name="return-values"></a><span data-ttu-id="ca7e9-306">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-306">Return Values</span></span>
...
## <a name="nx_ppp_link_down_notify"></a><span data-ttu-id="ca7e9-330">nx_ppp_link_down_notify</span><span class="sxs-lookup"><span data-stu-id="ca7e9-330">nx_ppp_link_down_notify</span></span>
...
### <a name="allowed-from"></a><span data-ttu-id="ca7e9-343">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-343">Allowed From</span></span>
...
### <a name="input-parameters"></a><span data-ttu-id="ca7e9-352">Parâmetros de Entrada</span><span class="sxs-lookup"><span data-stu-id="ca7e9-352">Input Parameters</span></span>
...
<span data-ttu-id="ca7e9-363">Notificar o pedido se a autenticação NAK recebida</span><span class="sxs-lookup"><span data-stu-id="ca7e9-363">Notify application if authentication NAK received</span></span>
...
<span data-ttu-id="ca7e9-376">Inicialização, fios, temporizadores, ISRs</span><span class="sxs-lookup"><span data-stu-id="ca7e9-376">Initialization, threads, timers, ISRs</span></span>
...
### <a name="allowed-from"></a><span data-ttu-id="ca7e9-402">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-402">Allowed From</span></span>
...
<span data-ttu-id="ca7e9-406">Envie um pedido de ping LCP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-406">Send an LCP ping request</span></span>
...
### <a name="return-values"></a><span data-ttu-id="ca7e9-420">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-420">Return Values</span></span>
...
<span data-ttu-id="ca7e9-429">Envie uma cadeia ASCII crua</span><span class="sxs-lookup"><span data-stu-id="ca7e9-429">Send a raw ASCII string</span></span>
...
### <a name="example"></a><span data-ttu-id="ca7e9-443">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ca7e9-443">Example</span></span>
...
- <span data-ttu-id="ca7e9-455">NX_CALLER_ERROR: (0x11) Inválido deste serviço.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-455">NX_CALLER_ERROR: (0x11) Invalid caller of this service.</span></span>

### <a name="allowed-from"></a><span data-ttu-id="ca7e9-456">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-456">Allowed From</span></span>

<span data-ttu-id="ca7e9-457">Fios</span><span class="sxs-lookup"><span data-stu-id="ca7e9-457">Threads</span></span>

### <a name="example"></a><span data-ttu-id="ca7e9-458">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ca7e9-458">Example</span></span>
...
## <a name="nx_ppp_start"></a><span data-ttu-id="ca7e9-459">nx_ppp_start</span><span class="sxs-lookup"><span data-stu-id="ca7e9-459">nx_ppp_start</span></span>

<span data-ttu-id="ca7e9-460">Iniciar o processamento de PPP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-460">Start PPP processing</span></span>

### <a name="prototype"></a><span data-ttu-id="ca7e9-461">Prototype</span><span class="sxs-lookup"><span data-stu-id="ca7e9-461">Prototype</span></span>

```c
UINT  nx_ppp_start(NX_PPP *ppp_ptr);
```

### <a name="description"></a><span data-ttu-id="ca7e9-462">Descrição</span><span class="sxs-lookup"><span data-stu-id="ca7e9-462">Description</span></span>

<span data-ttu-id="ca7e9-463">Este serviço inicia o processamento de PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-463">This service starts the PPP processing.</span></span> <span data-ttu-id="ca7e9-464">É normalmente chamado após nx_ppp_stop chamado.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-464">It is typically called after nx_ppp_stop() called.</span></span>

>[!NOTE]
> <span data-ttu-id="ca7e9-465">PPP inicia automaticamente o processamento de PPP quando a ligação está ativada.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-465">PPP automatically starts the PPP processing when the link is enabled.</span></span>

### <a name="input-parameters"></a><span data-ttu-id="ca7e9-466">Parâmetros de Entrada</span><span class="sxs-lookup"><span data-stu-id="ca7e9-466">Input Parameters</span></span>

- <span data-ttu-id="ca7e9-467">**ppp_ptr**: Ponteiro para o bloco de controlo PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-467">**ppp_ptr**: Pointer to PPP control block.</span></span>

### <a name="return-values"></a><span data-ttu-id="ca7e9-468">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-468">Return Values</span></span>

- <span data-ttu-id="ca7e9-469">**NX_SUCCESS**: (0x00) Início de PPP bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-469">**NX_SUCCESS**: (0x00) Successful PPP start initiated.</span></span> 
- <span data-ttu-id="ca7e9-470">**NX_PPP_ALREADY_STARTED**: PPP (0xb9) já começou.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-470">**NX_PPP_ALREADY_STARTED**: (0xb9) PPP already started.</span></span>
- <span data-ttu-id="ca7e9-471">NX_PTR_ERROR: (0x07) Ponteiro PPP inválido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-471">NX_PTR_ERROR: (0x07) Invalid PPP pointer.</span></span>
- <span data-ttu-id="ca7e9-472">NX_CALLER_ERROR: (0x11) Inválido deste serviço.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-472">NX_CALLER_ERROR: (0x11) Invalid caller of this service.</span></span>

### <a name="allowed-from"></a><span data-ttu-id="ca7e9-473">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-473">Allowed From</span></span>

<span data-ttu-id="ca7e9-474">Fios</span><span class="sxs-lookup"><span data-stu-id="ca7e9-474">Threads</span></span>

### <a name="example"></a><span data-ttu-id="ca7e9-475">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ca7e9-475">Example</span></span>
...
## <a name="nx_ppp_status_get"></a><span data-ttu-id="ca7e9-476">nx_ppp_status_get</span><span class="sxs-lookup"><span data-stu-id="ca7e9-476">nx_ppp_status_get</span></span>

<span data-ttu-id="ca7e9-477">Obtenha o estado atual de PPP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-477">Get current PPP status</span></span>

### <a name="prototype"></a><span data-ttu-id="ca7e9-478">Prototype</span><span class="sxs-lookup"><span data-stu-id="ca7e9-478">Prototype</span></span>

```c
UINT  nx_ppp_status_get(NX_PPP *ppp_ptr, UINT *status_ptr);
```
### <a name="description"></a><span data-ttu-id="ca7e9-479">Descrição</span><span class="sxs-lookup"><span data-stu-id="ca7e9-479">Description</span></span>

<span data-ttu-id="ca7e9-480">Este serviço obtém o estado atual da instância de PPP especificada.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-480">This service gets the current status of the specified PPP instance.</span></span>

### <a name="input-parameters"></a><span data-ttu-id="ca7e9-481">Parâmetros de Entrada</span><span class="sxs-lookup"><span data-stu-id="ca7e9-481">Input Parameters</span></span>

- <span data-ttu-id="ca7e9-482">**ppp_ptr**: Ponteiro para o bloco de controlo PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-482">**ppp_ptr**: Pointer to PPP control block.</span></span>
- <span data-ttu-id="ca7e9-483">**status_ptr**: Destino para o estado de PPP, são possíveis valores de estado:</span><span class="sxs-lookup"><span data-stu-id="ca7e9-483">**status_ptr**: Destination for the PPP status, the following are possible status values:</span></span>
    - <span data-ttu-id="ca7e9-484">**NX_PPP_STATUS_ESTABLISHED**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-484">**NX_PPP_STATUS_ESTABLISHED**</span></span>
    - <span data-ttu-id="ca7e9-485">**NX_PPP_STATUS_LCP_IN_PROGRESS**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-485">**NX_PPP_STATUS_LCP_IN_PROGRESS**</span></span>
    - <span data-ttu-id="ca7e9-486">**NX_PPP_STATUS_LCP_FAILED**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-486">**NX_PPP_STATUS_LCP_FAILED**</span></span>
    - <span data-ttu-id="ca7e9-487">**NX_PPP_STATUS_PAP_IN_PROGRESS**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-487">**NX_PPP_STATUS_PAP_IN_PROGRESS**</span></span>
    - <span data-ttu-id="ca7e9-488">**NX_PPP_STATUS_PAP_FAILED**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-488">**NX_PPP_STATUS_PAP_FAILED**</span></span>
    - <span data-ttu-id="ca7e9-489">**NX_PPP_STATUS_CHAP_IN_PROGRESS**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-489">**NX_PPP_STATUS_CHAP_IN_PROGRESS**</span></span>
    - <span data-ttu-id="ca7e9-490">**NX_PPP_STATUS_CHAP_FAILED**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-490">**NX_PPP_STATUS_CHAP_FAILED**</span></span>
    - <span data-ttu-id="ca7e9-491">**NX_PPP_STATUS_IPCP_IN_PROGRESS**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-491">**NX_PPP_STATUS_IPCP_IN_PROGRESS**</span></span>
    - <span data-ttu-id="ca7e9-492">**NX_PPP_STATUS_IPCP_FAILED**</span><span class="sxs-lookup"><span data-stu-id="ca7e9-492">**NX_PPP_STATUS_IPCP_FAILED**</span></span>

>[!NOTE]
> <span data-ttu-id="ca7e9-493">O estatuto só é válido se a API devolver NX_SUCCESS.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-493">The status is only valid if the API returns NX_SUCCESS.</span></span> <span data-ttu-id="ca7e9-494">Além disso, se algum dos valores de estado \*_FAILED for devolvido, o processamento de PPP é efetivamente interrompido até que seja reiniciado novamente pela aplicação.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-494">In addition, if any of the \*_FAILED status values are returned, PPP processing is effectively stopped until it is restarted again by the application.</span></span>

### <a name="return-values"></a><span data-ttu-id="ca7e9-495">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-495">Return Values</span></span>

- <span data-ttu-id="ca7e9-496">**NX_SUCCESS:**(0x00) Pedido de estado de PPP bem sucedido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-496">**NX_SUCCESS**: (0x00) Successful PPP status request.</span></span>
- <span data-ttu-id="ca7e9-497">NX_PTR_ERROR: (0x07) Ponteiro PPP inválido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-497">NX_PTR_ERROR: (0x07) Invalid PPP pointer.</span></span>

### <a name="allowed-from"></a><span data-ttu-id="ca7e9-498">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-498">Allowed From</span></span>

<span data-ttu-id="ca7e9-499">Inicialização, fios, temporizadores, ISRs</span><span class="sxs-lookup"><span data-stu-id="ca7e9-499">Initialization, threads, timers, ISRs</span></span>

### <a name="example"></a><span data-ttu-id="ca7e9-500">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ca7e9-500">Example</span></span>
...
/* If status is NX_SUCCESS the current internal PPP status is contained in
   “ppp_status”. */
```
## <a name="nx_ppp_stop"></a><span data-ttu-id="ca7e9-501">nx_ppp_stop</span><span class="sxs-lookup"><span data-stu-id="ca7e9-501">nx_ppp_stop</span></span>

<span data-ttu-id="ca7e9-502">Iniciar o processamento de PPP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-502">Start PPP processing</span></span>

### <a name="prototype"></a><span data-ttu-id="ca7e9-503">Prototype</span><span class="sxs-lookup"><span data-stu-id="ca7e9-503">Prototype</span></span>

```c
UINT  nx_ppp_stop(NX_PPP *ppp_ptr);
```

### <a name="description"></a><span data-ttu-id="ca7e9-504">Descrição</span><span class="sxs-lookup"><span data-stu-id="ca7e9-504">Description</span></span>

<span data-ttu-id="ca7e9-505">Este serviço impede o processamento de PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-505">This service stops the PPP processing.</span></span> <span data-ttu-id="ca7e9-506">O utilizador também pode ligar nx_ppp_start para iniciar o processamento de PPP, se necessário.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-506">User also can calls nx_ppp_start() to start the PPP processing if needed.</span></span>

### <a name="input-parameters"></a><span data-ttu-id="ca7e9-507">Parâmetros de Entrada</span><span class="sxs-lookup"><span data-stu-id="ca7e9-507">Input Parameters</span></span>

- <span data-ttu-id="ca7e9-508">**ppp_ptr**: Ponteiro para o bloco de controlo PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-508">**ppp_ptr**: Pointer to PPP control block.</span></span>

### <a name="return-values"></a><span data-ttu-id="ca7e9-509">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-509">Return Values</span></span>

- <span data-ttu-id="ca7e9-510">**NX_SUCCESS**: (0x00) Início de PPP bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-510">**NX_SUCCESS**: (0x00) Successful PPP start initiated.</span></span> 
- <span data-ttu-id="ca7e9-511">**NX_PPP_ALREADY_STOPPED**: (0xb8) PPP já parou.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-511">**NX_PPP_ALREADY_STOPPED**: (0xb8) PPP already stopped.</span></span>
- <span data-ttu-id="ca7e9-512">NX_PTR_ERROR: (0x07) Ponteiro PPP inválido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-512">NX_PTR_ERROR: (0x07) Invalid PPP pointer.</span></span>
- <span data-ttu-id="ca7e9-513">NX_CALLER_ERROR (0x11) Inválido deste serviço.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-513">NX_CALLER_ERROR (0x11) Invalid caller of this service.</span></span>

### <a name="allowed-from"></a><span data-ttu-id="ca7e9-514">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-514">Allowed From</span></span>

<span data-ttu-id="ca7e9-515">Fios</span><span class="sxs-lookup"><span data-stu-id="ca7e9-515">Threads</span></span>

### <a name="example"></a><span data-ttu-id="ca7e9-516">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ca7e9-516">Example</span></span>
...
```
## <a name="nx_ppp_packet_receive"></a><span data-ttu-id="ca7e9-517">nx_ppp_packet_receive</span><span class="sxs-lookup"><span data-stu-id="ca7e9-517">nx_ppp_packet_receive</span></span>

<span data-ttu-id="ca7e9-518">Receber pacote de PPP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-518">Receive PPP packet</span></span>

### <a name="prototype"></a><span data-ttu-id="ca7e9-519">Prototype</span><span class="sxs-lookup"><span data-stu-id="ca7e9-519">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ca7e9-520">Descrição</span><span class="sxs-lookup"><span data-stu-id="ca7e9-520">Description</span></span>

<span data-ttu-id="ca7e9-521">Este serviço recebe pacote de PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-521">This service receives PPP packet.</span></span>

### <a name="input-parameters"></a><span data-ttu-id="ca7e9-522">Parâmetros de Entrada</span><span class="sxs-lookup"><span data-stu-id="ca7e9-522">Input Parameters</span></span>

- <span data-ttu-id="ca7e9-523">**ppp_ptr**: Ponteiro para o bloco de controlo PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-523">**ppp_ptr**: Pointer to PPP control block.</span></span>
- <span data-ttu-id="ca7e9-524">**packet_ptr**: Ponteiro para pacote de PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-524">**packet_ptr**: Pointer to PPP packet.</span></span>

### <a name="return-values"></a><span data-ttu-id="ca7e9-525">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-525">Return Values</span></span>

- <span data-ttu-id="ca7e9-526">**NX_SUCCESS:**(0x00) Pedido de estado de PPP bem sucedido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-526">**NX_SUCCESS**: (0x00) Successful PPP status request.</span></span>
- <span data-ttu-id="ca7e9-527">NX_PTR_ERROR: (0x07) Ponteiro PPP inválido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-527">NX_PTR_ERROR: (0x07) Invalid PPP pointer.</span></span>

### <a name="allowed-from"></a><span data-ttu-id="ca7e9-528">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-528">Allowed From</span></span>

<span data-ttu-id="ca7e9-529">Inicialização, fios</span><span class="sxs-lookup"><span data-stu-id="ca7e9-529">Initialization, threads</span></span>

### <a name="example"></a><span data-ttu-id="ca7e9-530">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ca7e9-530">Example</span></span>
...
```
## <a name="nx_ppp_packet_send_set"></a><span data-ttu-id="ca7e9-531">nx_ppp_packet_send_set</span><span class="sxs-lookup"><span data-stu-id="ca7e9-531">nx_ppp_packet_send_set</span></span>

<span data-ttu-id="ca7e9-532">Desaperte a função de envio de pacote de PPP</span><span class="sxs-lookup"><span data-stu-id="ca7e9-532">Set the PPP packet send function</span></span>

### <a name="prototype"></a><span data-ttu-id="ca7e9-533">Prototype</span><span class="sxs-lookup"><span data-stu-id="ca7e9-533">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ca7e9-534">Descrição</span><span class="sxs-lookup"><span data-stu-id="ca7e9-534">Description</span></span>

<span data-ttu-id="ca7e9-535">Este serviço define o pacote de PPP enviar funciton.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-535">This service sets the PPP packet send funciton.</span></span>

### <a name="input-parameters"></a><span data-ttu-id="ca7e9-536">Parâmetros de Entrada</span><span class="sxs-lookup"><span data-stu-id="ca7e9-536">Input Parameters</span></span>

- <span data-ttu-id="ca7e9-537">**ppp_ptr**: Ponteiro para o bloco de controlo PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-537">**ppp_ptr**: Pointer to PPP control block.</span></span>
- <span data-ttu-id="ca7e9-538">**nx_ppp_packet_send:** Rotina para enviar pacote de PPP.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-538">**nx_ppp_packet_send**: Routine to send PPP packet.</span></span>

### <a name="return-values"></a><span data-ttu-id="ca7e9-539">Valores de devolução</span><span class="sxs-lookup"><span data-stu-id="ca7e9-539">Return Values</span></span>

- <span data-ttu-id="ca7e9-540">**NX_SUCCESS:**(0x00) Pedido de estado de PPP bem sucedido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-540">**NX_SUCCESS**: (0x00) Successful PPP status request.</span></span>
- <span data-ttu-id="ca7e9-541">NX_PTR_ERROR: (0x07) Ponteiro PPP inválido.</span><span class="sxs-lookup"><span data-stu-id="ca7e9-541">NX_PTR_ERROR: (0x07) Invalid PPP pointer.</span></span>

### <a name="allowed-from"></a><span data-ttu-id="ca7e9-542">Permitido a partir de</span><span class="sxs-lookup"><span data-stu-id="ca7e9-542">Allowed From</span></span>

<span data-ttu-id="ca7e9-543">Inicialização, fios</span><span class="sxs-lookup"><span data-stu-id="ca7e9-543">Initialization, threads</span></span>

### <a name="example"></a><span data-ttu-id="ca7e9-544">Exemplo</span><span class="sxs-lookup"><span data-stu-id="ca7e9-544">Example</span></span>
