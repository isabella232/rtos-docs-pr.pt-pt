...
#### <a name="building-module-manager-for-arm11-using-gcc"></a>Gestor de módulos de construção para ARM11 usando GCC
...
### <a name="arm11-using-ac5"></a>ARM11 usando AC5

#### <a name="module-preamble-for-arm11-using-ac5"></a>Preâmbulo do módulo para ARM11 utilizando AC5
...
#### <a name="module-linker-for-arm11-using-ac5"></a>Linker do módulo para ARM11 usando AC5

Construído na linha de comando, nenhum exemplo de ficheiro linker.

#### <a name="building-modules-for-arm11-using-ac5"></a>Módulos de construção para ARM11 usando AC5

Um exemplo simples de linha de comando para a construção de um módulo ARM11 utilizando AC5:
...
#### <a name="thread-extension-definition-for-arm11-using-ac5"></a>Definição de extensão de fio para ARM11 usando AC5
...
#### <a name="building-module-manager-for-arm11-using-ac5"></a>Gestor de módulos de construção para ARM11 usando AC5

Um exemplo simples de linha de comando para a construção de um gestor de módulos ARM11 utilizando AC5:
...
#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-ac5"></a>Atributos para memória externa permitem a API para ARM11 usando AC5

Esta funcionalidade não está ativada nesta porta.

## <a name="cortex-a7-processor"></a>Processador Córtex-A7

### <a name="cortex-a7-using-ac5"></a>Córtex-A7 usando AC5

#### <a name="module-preamble-for-cortex-a7-using-ac5"></a>Preâmbulo do módulo para o Córtex-A7 utilizando AC5
...
#### <a name="module-linker-for-cortex-a7-using-ac5"></a>Linker do módulo para Cortex-A7 usando AC5

Construído na linha de comando, nenhum exemplo de ficheiro linker.

#### <a name="building-modules-for-cortex-a7-using-ac5"></a>Módulos de construção para córtex-A7 usando AC5

Um exemplo simples de linha de comando para a construção de um módulo Córtex-A7 utilizando AC5:
...
#### <a name="thread-extension-definition-for-cortex-a7-using-ac5"></a>Definição de extensão de fio para córtex-A7 usando AC5
...
#### <a name="building-module-manager-for-cortex-a7-using-ac5"></a>Gestor de módulos de construção para Cortex-A7 usando AC5

Um exemplo simples de linha de comando para a construção de um gestor de módulos Cortex-A7 utilizando AC5:
...
| TXM_MMU_ATTRIBUTE_B | Definição B |
| TXM_MMU_ATTRIBUTE_C | Definição C |
| TXM_MMU_ATTRIBUTE_AP | Definição AP |
| TXM_MMU_ATTRIBUTE_TEX | Definição de TEX |

Consulte a documentação da ARM sobre a configuração destas definições.

## <a name="cortex-m3-processor"></a>Processador Córtex-M3

### <a name="cortex-m3-using-ac5"></a>Córtex-M3 usando AC5

#### <a name="module-preamble-for-cortex-m3-using-ac5"></a>Preâmbulo do módulo para o Córtex-M3 utilizando AC5
...
#### <a name="module-linker-for-cortex-m3-using-ac5"></a>Linker do módulo para Cortex-M3 usando AC5

Não é fornecido nenhum ficheiro de linker de exemplo; a ligação é feita na linha de comando. Veja a próxima secção.

#### <a name="building-modules-for-cortex-m3-using-ac5"></a>Módulos de construção para córtex-M3 usando AC5

Um script de construção de exemplo é fornecido:
...
#### <a name="thread-extension-definition-for-cortex-m3-using-ac5"></a>Definição de extensão de fio para córtex-M3 usando AC5
...
#### <a name="building-module-manager-for-cortex-m3-using-ac5"></a>Gestor de módulos de construção para Cortex-M3 usando AC5

Veja o exemplo build_threadx_module_manager_demo.bat:
...
### <a name="cortex-m3-using-ac6"></a>Córtex-M3 usando AC6

#### <a name="module-preamble-for-cortex-m3-using-ac6"></a>Preâmbulo do módulo para o Córtex-M3 utilizando AC6
...
#### <a name="module-linker-for-cortex-m3-using-ac6"></a>Linker do módulo para Cortex-M3 usando AC6

Não é utilizado nenhum ficheiro linker. Consulte as definições do projeto.

#### <a name="building-modules-for-cortex-m3-using-ac6"></a>Módulos de construção para córtex-M3 usando AC6

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de amostra e o projeto de gestor de módulos de amostra.

#### <a name="thread-extension-definition-for-cortex-m3-using-ac6"></a>Definição de extensão de fio para córtex-M3 usando AC6
...
#### <a name="building-module-manager-for-cortex-m3-using-ac6"></a>Gestor de módulos de construção para Cortex-M3 usando AC6
...
### <a name="cortex-m3-using-gnu"></a>Córtex-M3 usando GNU

#### <a name="module-preamble-for-cortex-m3-using-gnu"></a>Preâmbulo do módulo para o Córtex-M3 utilizando o GNU
...
#### <a name="module-linker-for-cortex-m3-using-gnu"></a>Linker do módulo para Cortex-M3 usando GNU
...
#### <a name="building-modules-for-cortex-m3-using-gnu"></a>Módulos de construção para córtex-M3 usando GNU

Ver build_threadx_module_sample.bat:
...
#### <a name="thread-extension-definition-for-cortex-m3-using-gnu"></a>Definição de extensão de fio para córtex-M3 usando GNU
...
#### <a name="building-module-manager-for-cortex-m3-using-gnu"></a>Gestor de módulos de construção para o Cortex-M3 usando o GNU

Ver build_threadx_module_manager_sample.bat:
...
### <a name="cortex-m3-using-iar"></a>Córtex-M3 usando IAR

#### <a name="module-preamble-for-cortex-m3-using-iar"></a>Preâmbulo do módulo para o Córtex-M3 utilizando o IAR
...
#### <a name="module-linker-for-cortex-m3-using-iar"></a>Linker do módulo para córtex-M3 usando IAR
...
#### <a name="building-modules-for-cortex-m3-using-iar"></a>Módulos de construção para córtex-M3 usando IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="thread-extension-definition-for-cortex-m3-using-iar"></a>Definição de extensão de fio para córtex-M3 usando IAR
...
#### <a name="building-module-manager-for-cortex-m3-using-iar"></a>Gestor de módulos de construção para Cortex-M3 usando IAR
...
## <a name="cortex-m33-processor"></a>Processador Córtex-M33

### <a name="cortex-m33-using-ac6"></a>Córtex-M33 usando AC6

#### <a name="module-preamble-for-cortex-m33-using-ac6"></a>Preâmbulo do módulo para o Córtex-M33 utilizando AC6
...
#### <a name="module-linker-for-cortex-m33-using-ac6"></a>Linker do módulo para Cortex-M33 usando AC6

Não é necessário nenhum ficheiro linker para o keil toolchain. Consulte as definições de construção no projeto exemplo.
As opções importantes do linker são listadas abaixo:

```c
--entry demo_module_start --first __txm_module_preamble
```

#### <a name="building-modules-for-cortex-m33-using-ac6"></a>Módulos de construção para córtex-M33 usando AC6
...
#### <a name="thread-extension-definition-for-cortex-m33-using-ac6"></a>Definição de extensão de fio para córtex-M33 usando AC6
...
#### <a name="building-module-manager-for-cortex-m33-using-ac6"></a>Gestor de módulos de construção para Cortex-M33 usando AC6

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, sample_threadx_module projeto e demo_threadx_non projeto de secure_zone.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-ac6"></a>Atributos para memória externa permitem API para córtex-M33 usando AC6

| Parâmetro de atributo |
|---|
...
### <a name="cortex-m33-using-gnu"></a>Córtex-M33 usando GNU

#### <a name="module-preamble-for-cortex-m33-using-gnu"></a>Preâmbulo do módulo para o Córtex-M33 utilizando o GNU
...
#### <a name="module-linker-for-cortex-m33-using-gnu"></a>Linker do módulo para córtex-M33 usando GNU

#### <a name="building-modules-for-cortex-m33-using-gnu"></a>Módulos de construção para córtex-M33 usando GNU

#### <a name="thread-extension-definition-for-cortex-m33-using-gnu"></a>Definição de extensão de fio para córtex-M33 usando GNU

#### <a name="building-module-manager-for-cortex-m33-using-gnu"></a>Gestor de módulos de construção para o Cortex-M33 usando o GNU

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-gnu"></a>Atributos para memória externa permitem API para córtex M33 usando GNU
...
### <a name="cortex-m33-using-iar"></a>Córtex-M33 usando IAR

#### <a name="module-preamble-for-cortex-m33-using-iar"></a>Preâmbulo do módulo para o Córtex-M33 utilizando o IAR
...
#### <a name="module-linker-for-cortex-m33-using-iar"></a>Linker do módulo para córtex-M33 usando IAR
...
#### <a name="building-modules-for-cortex-m33-using-iar"></a>Módulos de construção para córtex-M33 usando IAR

#### <a name="thread-extension-definition-for-cortex-m33-using-iar"></a>Definição de extensão de fio para córtex-M33 usando IAR
...
#### <a name="building-module-manager-for-cortex-m33-using-iar"></a>Gestor de módulos de construção para Cortex-M33 usando IAR

Um espaço de trabalho exemplo ainda não é fornecido. Brevemente.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-iar"></a>Atributos para memória externa permitem a API para o Córtex-M33 usando OAR
...
## <a name="cortex-m4-processor"></a>Processador Córtex-M4

### <a name="cortex-m4-using-ac5"></a>Córtex-M4 usando AC5

#### <a name="module-preamble-for-cortex-m4-using-ac5"></a>Preâmbulo do módulo para o Córtex-M4 utilizando AC5
...
#### <a name="module-linker-for-cortex-m4-using-ac5"></a>Linker do módulo para Cortex-M4 usando AC5

Não é fornecido nenhum ficheiro de linker de exemplo; a ligação é feita na linha de comando. Veja a próxima secção.

#### <a name="building-modules-for-cortex-m4-using-ac5"></a>Módulos de construção para córtex-M4 usando AC5

Veja o exemplo build_threadx_module_demo.bat:
...
#### <a name="thread-extension-definition-for-cortex-m4-using-ac5"></a>Definição de extensão de fio para córtex-M4 usando AC5
...
#### <a name="building-module-manager-for-cortex-m4-using-ac5"></a>Gestor de módulos de construção para o Cortex-M4 usando AC5
...
### <a name="cortex-m4-using-ac6"></a>Córtex-M4 usando AC6

#### <a name="module-preamble-for-cortex-m4-using-ac6"></a>Preâmbulo do módulo para o Córtex-M4 utilizando AC6
...
#### <a name="module-linker-for-cortex-m4-using-ac6"></a>Linker do módulo para Cortex-M4 usando AC6

Não é utilizado nenhum ficheiro linker. Consulte as definições do projeto.

#### <a name="building-modules-for-cortex-m4-using-ac6"></a>Módulos de construção para córtex-M4 usando AC6

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de amostra e o projeto de gestor de módulos de amostra.

#### <a name="thread-extension-definition-for-cortex-m4-using-ac6"></a>Definição de extensão de fio para córtex-M4 usando AC6
...
#### <a name="building-module-manager-for-cortex-m4-using-ac6"></a>Gestor de módulos de construção para o Cortex-M4 usando AC6
...
### <a name="cortex-m4-using-gnu"></a>Córtex-M4 usando GNU

#### <a name="module-preamble-for-cortex-m4-using-gnu"></a>Preâmbulo do módulo para o Córtex-M4 utilizando o GNU
...
#### <a name="module-linker-for-cortex-m4-using-gnu"></a>Linker do módulo para córtex-M4 usando GNU
...
#### <a name="building-modules-for-cortex-m4-using-gnu"></a>Módulos de construção para córtex-M4 usando GNU
...
#### <a name="thread-extension-definition-for-cortex-m4-using-gnu"></a>Definição de extensão de fio para córtex-M4 usando GNU
...
#### <a name="building-module-manager-for-cortex-m4-using-gnu"></a>Gestor de módulos de construção para o Cortex-M4 usando o GNU
...
### <a name="cortex-m4-using-iar"></a>Córtex-M4 usando IAR

#### <a name="module-preamble-for-cortex-m4-using-iar"></a>Preâmbulo do módulo para o Córtex-M4 utilizando o IAR
...
#### <a name="module-linker-for-cortex-m4-using-iar"></a>Linker do módulo para córtex-M4 usando IAR
...
#### <a name="building-modules-for-cortex-m4-using-iar"></a>Módulos de construção para córtex-M4 usando IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="thread-extension-definition-for-cortex-m4-using-iar"></a>Definição de extensão de fio para córtex-M4 usando IAR
...
#### <a name="building-module-manager-for-cortex-m4-using-iar"></a>Gestor de módulos de construção para Cortex-M4 usando IAR
...
## <a name="cortex-m7-processor"></a>Processador Córtex-M7

### <a name="cortex-m7-using-ac5"></a>Córtex-M7 usando AC5

#### <a name="module-preamble-for-cortex-m7-using-ac5"></a>Preâmbulo do módulo para o Córtex-M7 utilizando AC5
...
#### <a name="module-linker-for-cortex-m7-using-ac5"></a>Linker do módulo para Cortex-M7 usando AC5

Construído na linha de comando, nenhum exemplo de ficheiro linker.

#### <a name="building-modules-for-cortex-m7-using-ac5"></a>Módulos de construção para córtex-M7 usando AC5

Um exemplo simples de linha de comando para a construção de um módulo Cortex-M7 utilizando AC5:
...
#### <a name="thread-extension-definition-for-cortex-m7-using-ac5"></a>Definição de extensão de fio para córtex-M7 usando AC5
...
#### <a name="building-module-manager-for-cortex-m7-using-ac5"></a>Gestor de módulos de construção para o Cortex-M7 usando AC5

Um exemplo simples de linha de comando para a construção de um gestor de módulos Cortex-M7 utilizando AC5:
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac5"></a>Atributos para memória externa permitem API para córtex-M7 usando AC5

### <a name="cortex-m7-using-ac6"></a>Córtex-M7 usando AC6
...
#### <a name="module-linker-for-cortex-m7-using-ac6"></a>Linker do módulo para Cortex-M7 usando AC6

Não é utilizado nenhum ficheiro linker. Consulte as definições do projeto.

#### <a name="building-modules-for-cortex-m7-using-ac6"></a>Módulos de construção para córtex-M7 usando AC6

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de amostra e o projeto de gestor de módulos de amostra.

#### <a name="thread-extension-definition-for-cortex-m7-using-ac6"></a>Definição de extensão de fio para córtex-M7 usando AC6
...
#### <a name="building-module-manager-for-cortex-m7-using-ac6"></a>Gestor de módulos de construção para o Cortex-M7 usando AC6
...
### <a name="cortex-m7-using-gnu"></a>Córtex-M7 usando GNU
...
#### <a name="module-linker-for-cortex-m7-using-gnu"></a>Linker do módulo para córtex-M7 usando GNU
...
#### <a name="building-modules-for-cortex-m7-using-gnu"></a>Módulos de construção para córtex-M7 usando GNU
...
#### <a name="thread-extension-definition-for-cortex-m7-using-gnu"></a>Definição de extensão de fio para córtex-M7 usando GNU
...
#### <a name="building-module-manager-for-cortex-m7-using-gnu"></a>Gestor de módulos de construção para o Cortex-M7 usando o GNU
...
### <a name="cortex-m7-using-iar"></a>Córtex-M7 usando IAR

#### <a name="module-preamble-for-cortex-m7-using-iar"></a>Preâmbulo do módulo para o Córtex-M7 utilizando o IAR
...
#### <a name="module-linker-for-cortex-m7-using-iar"></a>Linker do módulo para córtex-M7 usando IAR
...
#### <a name="building-modules-for-cortex-m7-using-iar"></a>Módulos de construção para córtex-M7 usando IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="thread-extension-definition-for-cortex-m7-using-iar"></a>Definição de extensão de fio para córtex-M7 usando IAR
...
#### <a name="building-module-manager-for-cortex-m7-using-iar"></a>Gestor de módulos de construção para Cortex-M7 usando IAR
...
## <a name="cortex-r4-processor"></a>Processador Córtex-R4

### <a name="cortex-r4-using-ac6"></a>Córtex-R4 usando AC6

#### <a name="module-preamble-for-cortex-r4-using-ac6"></a>Preâmbulo do módulo para o Córtex-R4 utilizando o CA6
...
#### <a name="module-linker-for-cortex-r4-using-ac6"></a>Linker do módulo para Cortex-R4 usando AC6

Construído na linha de comando, nenhum exemplo de ficheiro linker.

#### <a name="building-modules-for-cortex-r4-using-ac6"></a>Módulos de construção para córtex-R4 usando AC6

Um exemplo simples de linha de comando para a construção de um módulo Cortex-R4 utilizando AC6:
...
#### <a name="thread-extension-definition-for-cortex-r4-using-ac6"></a>Definição de extensão de fio para Cortex-R4 usando AC6
...
#### <a name="building-module-manager-for-cortex-r4-using-ac6"></a>Gestor de módulos de construção para Cortex-R4 usando AC6

Um exemplo simples de linha de comando para a construção de um gestor de módulos Cortex-R4 utilizando AC6:
...
### <a name="cortex-r4-using-iar"></a>Córtex-R4 usando IAR

#### <a name="module-preamble-for-cortex-r4-using-iar"></a>Preâmbulo do módulo para o Córtex-R4 utilizando o IAR
...
#### <a name="module-linker-for-cortex-r4-using-iar"></a>Linker do módulo para Cortex-R4 usando IAR
...
#### <a name="building-modules-for-cortex-r4-using-iar"></a>Módulos de construção para córtex-R4 usando o IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="thread-extension-definition-for-cortex-r4-using-iar"></a>Definição de extensão de fio para córtex-R4 usando IAR
...
#### <a name="building-module-manager-for-cortex-r4-using-iar"></a>Gestor de módulos de construção para Cortex-R4 usando IAR
...
## <a name="mcf544xx-processor"></a>Processador MCF544xx

### <a name="mcf544xx-using-ghs"></a>MCF544x usando GHS

#### <a name="module-preamble-for-mcf544xx-using-ghs"></a>Preâmbulo do módulo para MCF544xx usando GHS
...
| 2 | 0<br />1 | Desativar o acesso à memória partilhada/externa<br />Ativar o acesso à memória partilhada/externa |
| [23-3] | 0 | Reservado
| [31-24] | <br />0x03 | **ID do compilador**<br />RIO GHS |

#### <a name="module-linker-for-mcf544xx-using-ghs"></a>Linker de módulo para MCF544xx usando GHS
...
#### <a name="building-modules-for-mcf544xx-using-ghs"></a>Módulos de construção para MCF544xx usando GHS

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="thread-extension-definition-for-mcf544xx-using-ghs"></a>Definição de extensão de fio para MCF544xx usando GHS
...
#### <a name="building-module-manager-for-mcf544xx-using-ghs"></a>Gestor de módulos de construção para MCF544xx usando GHS

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="attributes-for-external-memory-enable-api-for-mcf544xx-using-ghs"></a>Atributos para memória externa permitem API para MCF544xx usando GHS

Esta funcionalidade não está ativada no MCF544xx.

## <a name="rx63-processor"></a>Processador RX63

### <a name="rx63-using-iar"></a>RX63 usando IAR

#### <a name="module-preamble-for-rx63-using-iar"></a>Preâmbulo do módulo para RX63 usando OAR
...
| 2 | 0<br />1 | Desativar o acesso à memória partilhada/externa<br />Ativar o acesso à memória partilhada/externa |
| [23-3] | 0 | Reservado
| [31-24] | <br />0x00<br />0x02 | **ID do compilador**<br />IAR<br />GNU |

#### <a name="module-linker-for-rx63-using-iar"></a>Linker do módulo para RX63 usando IAR
...
#### <a name="building-modules-for-rx63-using-iar"></a>Módulos de construção para RX63 usando IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="thread-extension-definition-for-rxrx635n-using-iar"></a>Definição de extensão de fio para RXRX635N usando IAR
...
#### <a name="building-module-manager-for-rx63-using-iar"></a>Gestor de módulos de construção para RX63 usando IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="attributes-for-external-memory-enable-api-for-rx63-using-iar"></a>Atributos para memória externa permitem a API para RX63 usando IAR

| Parâmetro de atributo | Significado |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_EXECUTE | Executar código |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | Acesso de escrita |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_READ | Acesso de leitura |

## <a name="rx65n-processor"></a>Processador RX65N

### <a name="rx65n-using-iar"></a>RX65N usando IAR

#### <a name="module-preamble-for-rx65n-using-iar"></a>Preâmbulo do módulo para RX65N usando o IAR
...
#### <a name="module-linker-for-rx65n-using-iar"></a>Linker do módulo para RX65N usando OAR
...
#### <a name="building-modules-for-rx65n-using-iar"></a>Módulos de construção para RX65N usando o IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="thread-extension-definition-for-rx65n-using-iar"></a>Definição de extensão de fio para RX65N usando IAR
...
#### <a name="building-module-manager-for-rx65n-using-iar"></a>Gestor de módulos de construção para RX65N usando IAR

Um espaço de trabalho exemplo é fornecido. Construa a biblioteca ThreadX, a biblioteca de módulos ThreadX, o projeto do módulo de demonstração e o projeto de gestor de módulos de demonstração.

#### <a name="attributes-for-external-memory-enable-api-for-rx65n-using-iar"></a>Atributos para memória externa permitem a API para RX65N usando IAR
