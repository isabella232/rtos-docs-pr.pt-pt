...
ms.locfileid: "116786404"
---
# <a name="guix-example"></a>Exemplo GUIX

O sistema de demonstração GUIX é entregue com um pequeno exemplo, definido em exemplos/helloworld/helloworld.c. Este exemplo ilustra os passos necessários para rubricar o sistema GUIX, para configurar os controladores de exibição. O código fonte está listado nas páginas seguintes.
