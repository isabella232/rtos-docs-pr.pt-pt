---
title: Exemplo GUIX
description: O sistema de demonstração GUIX é entregue com um pequeno exemplo, definido em exemplos/helloworld/helloworld.c.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104826341"
---
# <a name="guix-example"></a><span data-ttu-id="23239-103">Exemplo GUIX</span><span class="sxs-lookup"><span data-stu-id="23239-103">GUIX Example</span></span>

<span data-ttu-id="23239-104">O sistema de demonstração GUIX é entregue com um pequeno exemplo, definido em exemplos/helloworld/helloworld.c.</span><span class="sxs-lookup"><span data-stu-id="23239-104">The GUIX demonstration system is delivered with a small example, defined in examples/helloworld/helloworld.c.</span></span> <span data-ttu-id="23239-105">Este exemplo ilustra os passos necessários para rubricar o sistema GUIX, para configurar os controladores de exibição.</span><span class="sxs-lookup"><span data-stu-id="23239-105">This example illustrates the steps needed to take to initialize the GUIX system, to set up display drivers.</span></span> <span data-ttu-id="23239-106">O código fonte está listado nas páginas seguintes.</span><span class="sxs-lookup"><span data-stu-id="23239-106">The source code is listed on the following pages.</span></span>
