---
title: Capítulo 3 - Azure RTOS NetX BSD Services
description: Este capítulo contém uma descrição de todos os serviços básicos Azure RTOS NetX BSD listados abaixo por ordem alfabética.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104825598"
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a><span data-ttu-id="e640f-103">Capítulo 3 - Azure RTOS NetX BSD Services</span><span class="sxs-lookup"><span data-stu-id="e640f-103">Chapter 3 - Azure RTOS NetX BSD Services</span></span>

<span data-ttu-id="e640f-104">Este capítulo contém uma descrição de todos os serviços básicos Azure RTOS NetX BSD listados abaixo por ordem alfabética.</span><span class="sxs-lookup"><span data-stu-id="e640f-104">This chapter contains a description of all Azure RTOS NetX BSD basic services listed below in alphabetic order.</span></span>
