...
Este capítulo contém uma descrição de todos os serviços Azure RTOS NetX AutoIP (listados abaixo) por ordem alfabética.
...
- **NX_AUTO_IP_BAD_INTERFACE_INDEX:**(0xA02) Interface de rede inválida 
- NX_PTR_ERROR: (0x16) Ponteiro AutoIP inválido.
- NX_CALLER_ERROR: (0x11) Inválido deste serviço.
